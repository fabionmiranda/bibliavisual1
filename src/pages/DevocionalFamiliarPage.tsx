...
const SEMANAS = [
  { semana: 1,  titulo: 'Semana 1 — Mateus 1–5',        tema: 'O Rei prometido chega — fundamentos do Reino' },
  { semana: 2,  titulo: 'Semana 2 — Mateus 6–10',       tema: 'O Sermão do Monte e a missão' },
  { semana: 3,  titulo: 'Semana 3 — Mateus 11–15',      tema: 'Parábolas do Reino e fé em crise' },
  { semana: 4,  titulo: 'Semana 4 — Mateus 16–20',      tema: 'Identidade, transfiguração e serviço' },
  { semana: 5,  titulo: 'Semana 5 — Mateus 21–25',      tema: 'Jerusalém: conflito, julgamento e vigilância' },
  { semana: 6,  titulo: 'Semana 6 — Mateus 26–28 / Mc 1–2', tema: 'Paixão, ressurreição e novo começo' },
  { semana: 7,  titulo: 'Semana 7 — Marcos 3–7',        tema: 'O evangelho de ação — urgência e poder' },
  { semana: 8,  titulo: 'Semana 8 — Marcos 8–12',       tema: 'Confissão, serviço e controvérsia' },
  { semana: 9,  titulo: 'Semana 9 — Marcos 13–16 / Lc 1', tema: 'Escatologia e o anúncio da salvação' },
  { semana: 10, titulo: 'Semana 10 — Lucas 2–6',        tema: 'O Salvador nasce e inaugura o Reino' },
  { semana: 11, titulo: 'Semana 11 — Lucas 7–11',       tema: 'Fé, oração e compaixão' },
  { semana: 12, titulo: 'Semana 12 — Lucas 12–16',      tema: 'Riqueza, perdão e o coração do pai' },
  { semana: 13, titulo: 'Semana 13 — Lucas 17–21',      tema: 'Gratidão, humildade e fim dos tempos' },
  { semana: 14, titulo: 'Semana 14 — Lucas 22–24 / Jo 1–2', tema: 'Paixão, ressurreição e o Verbo encarnado' },
  { semana: 15, titulo: 'Semana 15 — João 3–7',         tema: 'Novo nascimento, água viva e pão da vida' },
  { semana: 16, titulo: 'Semana 16 — João 8–12',        tema: 'Luz do mundo, bom pastor e ressurreição' },
  { semana: 17, titulo: 'Semana 17 — João 13–17',       tema: 'Amor, permanência e oração sacerdotal' },
  { semana: 18, titulo: 'Semana 18 — João 18–21 / At 1', tema: 'Paixão, ressurreição e ascensão' },
  { semana: 19, titulo: 'Semana 19 — Atos 2–6',         tema: 'Pentecostes e o crescimento da Igreja' },
  { semana: 20, titulo: 'Semana 20 — Atos 7–11',        tema: 'Martírio, dispersão e fronteiras rompidas' },
  { semana: 21, titulo: 'Semana 21 — Atos 12–16',       tema: 'Missão, concílio e a visão da Macedônia' },
  { semana: 22, titulo: 'Semana 22 — Atos 17–21',       tema: 'Atenas, Corinto e os últimos passos de Paulo' },
  { semana: 23, titulo: 'Semana 23 — Atos 22–26',       tema: 'Paulo preso, mas a Palavra livre' },
  { semana: 24, titulo: 'Semana 24 — Atos 27–28 / Rm 1–3', tema: 'Naufrágio, Roma e o evangelho da justiça' },
  { semana: 25, titulo: 'Semana 25 — Romanos 4–8',      tema: 'Fé de Abraão e vida no Espírito' },
  { semana: 26, titulo: 'Semana 26 — Romanos 9–13',     tema: 'Soberania, misericórdia e amor prático' },
  { semana: 27, titulo: 'Semana 27 — Romanos 14–16 / 1Co 1–2', tema: 'Unidade e a sabedoria da cruz' },
  { semana: 28, titulo: 'Semana 28 — 1 Coríntios 3–7',  tema: 'Fundação, pureza e o casamento em Cristo' },
  { semana: 29, titulo: 'Semana 29 — 1 Coríntios 8–12', tema: 'Liberdade, ceia e dons do Espírito' },
  { semana: 30, titulo: 'Semana 30 — 1Co 13–16 / 2Co 1', tema: 'O amor, a ressurreição e o consolo' },
  { semana: 31, titulo: 'Semana 31 — 2 Coríntios 2–6',  tema: 'Vasos de barro e nova criação' },
  { semana: 32, titulo: 'Semana 32 — 2 Coríntios 7–11', tema: 'Generosidade e poder na fraqueza' },
  { semana: 33, titulo: 'Semana 33 — 2Co 12–13 / Gl 1–3', tema: 'Fraqueza gloriosa e o único evangelho' },
  { semana: 34, titulo: 'Semana 34 — Gálatas 4–6 / Ef 1–2', tema: 'Filhos, não escravos — salvos pela graça' },
  { semana: 35, titulo: 'Semana 35 — Efésios 3–6 / Fl 1', tema: 'O lar aliançado e a armadura de Deus' },
  { semana: 36, titulo: 'Semana 36 — Fl 2–4 / Cl 1–2',  tema: 'Humildade, paz e a supremacia de Cristo' },
  { semana: 37, titulo: 'Semana 37 — Cl 3–4 / 1Ts 1–3', tema: 'Nova vida e a Igreja que ressoa o evangelho' },
  { semana: 38, titulo: 'Semana 38 — 1Ts 4–5 / 2Ts 1–3', tema: 'Santidade, vinda do Senhor e trabalho fiel' },
  { semana: 39, titulo: 'Semana 39 — 1 Timóteo 1–5',    tema: 'Sã doutrina e cuidado pastoral' },
  { semana: 40, titulo: 'Semana 40 — 1Tm 6 / 2Tm 1–4',  tema: 'Contentamento e o bom combate da fé' },
  { semana: 41, titulo: 'Semana 41 — Tt 1–3 / Fm / Hb 1', tema: 'Graça que ensina e o Filho superior' },
  { semana: 42, titulo: 'Semana 42 — Hebreus 2–6',      tema: 'O sumo sacerdote compassivo e o repouso' },
  { semana: 43, titulo: 'Semana 43 — Hebreus 7–11',     tema: 'O pacto eterno e os heróis da fé' },
  { semana: 44, titulo: 'Semana 44 — Hb 12–13 / Tg 1–3', tema: 'A corrida da fé e a fé que age' },
  { semana: 45, titulo: 'Semana 45 — Tg 4–5 / 1Pe 1–3', tema: 'Humildade e a esperança viva' },
  { semana: 46, titulo: 'Semana 46 — 1Pe 4–5 / 2Pe 1–3', tema: 'Sofrimento, glória e o dia do Senhor' },
  { semana: 47, titulo: 'Semana 47 — 1 João 1–5',       tema: 'Luz, amor e vitória pela fé' },
  { semana: 48, titulo: 'Semana 48 — 2Jo / 3Jo / Jd / Ap 1–2', tema: 'Fidelidade e as cartas às igrejas' },
  { semana: 49, titulo: 'Semana 49 — Apocalipse 3–7',   tema: 'O trono, o Cordeiro e a multidão' },
  { semana: 50, titulo: 'Semana 50 — Apocalipse 8–12',  tema: 'As trombetas e a guerra cósmica' },
  { semana: 51, titulo: 'Semana 51 — Apocalipse 13–17', tema: 'A besta e a queda de Babilônia' },
  { semana: 52, titulo: 'Semana 52 — Apocalipse 18–22', tema: 'A vitória final e a cidade eterna' },
];
