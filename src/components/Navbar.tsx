        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-1 lg:gap-2">
            ...
            >
              Admin
              <span className={cn(
                'absolute -bottom-1 left-0 right-0 h-px rounded-full',
                location.pathname === '/admin'
                  ? 'bg-brand-rose'
                  : 'bg-brand-rose scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-left'
              )} />
            </Link>
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col gap-1">
              ...
              <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.18 }}>
                <button
                  onClick={scrollToFooter}
                  className="flex items-center w-full px-4 py-3.5 rounded-xl font-black uppercase tracking-widest text-sm text-white/75 hover:text-white hover:bg-white/[0.04] border border-transparent transition-all duration-200"
                >
                  Contatos
                </button>
              </motion.div>
              ...
              <div className="flex flex-col gap-3 mt-4 pt-4 border-t border-white/[0.07]">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={close}
                  className="w-full py-3.5 border border-brand-blue/40 text-brand-blue font-black rounded-2xl text-center uppercase tracking-widest text-sm"
                >
                  Unir-se ao Clube
                </a>
                <Link
                  to="/biblioteca"
                  onClick={close}
                  className="w-full py-3.5 bg-brand-blue text-bg-deep font-black rounded-2xl text-center uppercase tracking-widest text-sm shadow-lg shadow-brand-blue/20"
                >
                  Acessar
                </Link>
              </div>
