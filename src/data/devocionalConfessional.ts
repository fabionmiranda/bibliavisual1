...
// ============================================================================
// Junho — Dias 152–159 — Catecismo Menor de Westminster (CMW) P.1–P.11
// ============================================================================
  ...
  const dias: DiaCompacto[] = [
    {
      dia: 152,
      data: '1 de junho',
      tema: 'Para Que Existimos? Uma Pergunta Que Muda Tudo',
      capitulo: 'CMW P.1',
      versiculo: '1 Coríntios 10.31',
      versiculoTexto: 'Portanto, quer comais, quer bebais, ou façais qualquer outra coisa, fazei tudo para a glória de Deus.',
      confissaoTexto: 'Pergunta 1: Qual é o fim principal do homem? Resposta: O fim principal do homem é glorificar a Deus e fruí-lo para sempre.',
      cfwRef: 'CFW — Prefácio / CB 1689 — Prefácio',
      cfwComparacao: 'Esta primeira pergunta do CMW condensa toda a teologia reformada em uma frase: glória de Deus como fim, fruição de Deus como conteúdo. CFW e CB 1689 partem deste axioma — toda doutrina serve ao fim de glorificar e gozar a Deus. Não existe teologia reformada sem este telos: Deus é glorificado e o homem é feliz — e esses dois fins coincidem perfeitamente.',
      exposicao: 'Glorificar a Deus não é apenas cantar hinos — é fazer tudo de modo que Deus apareça como supremo. Fruí-lo para sempre significa que a felicidade humana não está na criatura, mas no Criador. Quando glória e fruição coincidem em Deus, toda idolatria perde seu apelo.',
      reforco: 'Salmos 73.25-26',
      aplicacoes: {
        digital: 'Antes de postar, pergunte: isso glorifica a Deus ou glorifica a mim? A resposta muda o que você publica.',
        familia: 'Ore com a família: "Senhor, que hoje façamos tudo — o café, o trabalho, as refeições — para a tua glória."',
        filhos: 'Ensine aos filhos: "Fomos feitos para Deus, não para nós mesmos. Isso muda tudo o que fazemos."',
        homens: 'O homem que sabe para que existe não desperdiça sua vida em ambições vazias — ele investe na glória de Deus.',
        mulheres: 'A mulher que vive para a glória de Deus encontra dignidade em cada tarefa, por menor que pareça.',
        igreja: 'A Igreja que perde de vista o fim principal — glória de Deus — torna-se clube social ou teatro de entretenimento.',
      },
      oracao: 'Senhor, que eu não viva para mim mesmo. Que cada escolha, cada palavra, cada ação seja dirigida a tua glória. E que ao te glorificar eu descubra a única fruição que jamais decepciona. Amém.',
      reflexao: 'Se o fim do homem é glorificar a Deus e fruí-lo para sempre, então toda pergunta sobre o sentido da vida já foi respondida. O problema não é falta de propósito — é desvio do propósito. Retornar a Deus é retornar ao fim para o qual fomos feitos.',
      aplicacao: 'Escolha uma atividade rotineira de hoje — refeição, trabalho, conversa — e pratique conscientemente fazê-la para a glória de Deus. Anote como essa intenção muda sua postura.',
      notas: [
        'PIPER, John. <em>Desiring God</em>. Portland: Multnomah, 1986. Demonstra que glorificar a Deus e fruí-lo não são objetivos concorrentes — são um só: "God is most glorified in us when we are most satisfied in him."',
        'WESTMINSTER ASSEMBLY. <em>Shorter Catechism</em>, 1647. Q.1. A pergunta inaugural do CMW é considerada o resumo mais preciso da teologia reformada em uma frase.',
      ],
      notaInicio: 308,
    },
    {
      dia: 153,
      data: '2 de junho',
      tema: 'A Bíblia: A Única Regra de Fé — Por Que Só a Escritura Basta',
      capitulo: 'CMW P.2',
      ...
      confissaoTexto: 'Pergunta 2: Que regra deu Deus para nos dirigir na forma de o glorificar e gozar? Resposta: A Palavra de Deus, contida nas Escrituras do Antigo e Novo Testamento, é a única regra para nos dirigir na forma de glorificar e gozar a Deus.',
      cfwRef: 'CFW 1.1 / CB 1689 1.1',
      cfwComparacao: 'CFW 1.1 e CB 1689 1.1 expandem o que o CMW P.2 resume: a Escritura é suficiente, necessária e final. Nenhuma tradição, nenhuma voz interior, nenhum magistério humano adiciona à Palavra como regra de fé e prática. O CMW precisa desta afirmação antes de qualquer doutrina — sem a regra certa, toda doutrina fica à deriva.',
      exposicao: 'A Palavra de Deus não é uma entre várias fontes de autoridade — é a única regra. Isso não nega a utilidade das confissões ou da tradição, mas as subordina à Escritura. Sola Scriptura significa que a Bíblia é a instância final de apelação, não a única fonte de conhecimento.',
      reforco: 'Isaías 8.20',
      aplicacoes: {
        digital: 'Quando encontrar um ensinamento novo nas redes, pergunte: isso está ancorado na Escritura ou substitui a Escritura?',
        familia: 'Reserve um momento semanal para a família ler a Bíblia juntos — não como tradição, mas como submissão à única regra.',
        filhos: 'Ensine: "A Bíblia não é um livro de histórias — é a voz de Deus que nos diz como viver para a glória dele."',
        homens: 'O homem reformado não governa sua família por tradição familiar, mas pela Palavra — que é superior a qualquer costume.',
        mulheres: 'A mulher que conhece a Escritura não é dominada por modismos espirituais — ela tem a regra que testa tudo.',
        igreja: 'A Igreja que prega a Palavra acima de experiências, tendências e votações mantém o fundamento que não pode ser abalado.',
      },
      oracao: 'Senhor, guarda-nos de buscar outras regras. Que a tua Palavra seja suficiente para nós — como regra de fé, como guia de vida, como última autoridade. Que nunca adicionemos a ela nem subtraiamos dela. Amém.',
      reflexao: 'Toda heresia começa quando algo se coloca ao lado da Escritura como igual ou superior. A Reforma foi um retorno à Palavra como única regra — não rejeição da razão ou da tradição, mas reordenação: Escritura acima de tudo.',
      aplicacao: 'Identifique uma crença ou prática que você mantém por tradição familiar ou costume cultural. Pesquise se ela tem base clara na Escritura. Corrija o que precisar ser corrigido.',
      notas: [
        'MULLER, Richard A. <em>Post-Reformation Reformed Dogmatics</em>. Vol. 2: Holy Scripture. Grand Rapids: Baker, 2003. Estudo definitivo sobre a doutrina reformada da Escritura e seu papel como norma normans.',
        'FRAME, John M. <em>The Doctrine of the Word of God</em>. Phillipsburg: P&R, 2010. Análise sistemática da suficiência, necessidade e clareza da Escritura como única regra de fé.',
      ],
      notaInicio: 310,
    },
    {
      dia: 154,
      data: '3 de junho',
      tema: 'O Que a Bíblia Ensina? Deus, Nós, e o Caminho de Volta',
      capitulo: 'CMW P.3',
      ...
      confissaoTexto: 'Pergunta 3: O que é o que a Escritura principalmente nos ensina? Resposta: A Escritura principalmente nos ensina o que o homem há de crer acerca de Deus, e que dever Deus requer do homem.',
      cfwRef: 'CFW 1.6 / CB 1689 1.6',
      cfwComparacao: 'CFW 1.6 e CB 1689 1.6 afirmam que a Escritura contém tudo necessário para a salvação. O CMW P.3 estrutura isso em dois eixos: doutrina (o que crer sobre Deus) e ética (o que Deus requer). Toda teologia é doutrina mais obediência — separá-las gera intelectualismo vazio ou moralismo sem fundamento.',
      exposicao: 'A Escritura não é um livro de histórias edificantes — é revelação sistemática de quem Deus é e o que ele exige. O eixo doutrinário (o que crer) e o eixo ético (o que fazer) são inseparáveis: fé correta gera prática correta. Quem separa os dois tem ou uma ortodoxia morta ou um ativismo sem ancoragem.',
      reforco: 'Miquéias 6.8',
      aplicacoes: {
        digital: 'Consuma conteúdo que ensine tanto o que crer quanto o que fazer — não apenas motivação sem doutrina.',
        familia: 'Na família, estude doutrina e aplique eticamente: "O que aprendemos sobre Deus muda como tratamos uns aos outros?"',
        filhos: 'Ensine que a Bíblia tem duas grandes lições: quem é Deus e como devemos viver — e as duas andam juntas.',
        homens: 'O homem que só sabe o que crer, sem viver conforme, é fariseu. O que só age sem crer corretamente é moralista.',
        mulheres: 'Doutrina sem prática é arrogância; prática sem doutrina é humanismo. A mulher reformada une as duas.',
        igreja: 'A Igreja fiel prega tanto o ser de Deus quanto o dever do homem — teologia e ética integradas no mesmo sermão.',
      },
      oracao: 'Senhor, que a tua Palavra forme tanto o que creio quanto o que faço. Guarda-me da ortodoxia morta e do ativismo vazio. Que o conhecimento de ti produza obediência, e a obediência aprofunde o conhecimento. Amém.',
      reflexao: 'Toda heresia é, no fundo, ou erro doutrinário (crer errado sobre Deus) ou erro ético (fazer errado perante Deus). A Escritura corrige os dois. Por isso a teologia não é luxo acadêmico — é cuidado pastoral com a alma.',
      aplicacao: 'Escolha uma doutrina que estudou este ano e escreva como ela deveria mudar um comportamento concreto em sua vida. Prática sem doutrina é moralismo; doutrina sem prática é intelectualismo.',
      notas: [
        'CALVIN, John. <em>Institutes of the Christian Religion</em>. I.1.1. Calvino abre sua obra magna com a mesma estrutura do CMW P.3: conhecimento de Deus e conhecimento de si mesmo são os dois eixos de toda sabedoria.',
        'VANHOOZER, Kevin J. <em>The Drama of Doctrine</em>. Louisville: Westminster John Knox, 2005. Demonstra que doutrina não é teoria abstrata, mas script para a ação fiel do povo de Deus no mundo.',
      ],
      notaInicio: 312,
    },
    {
      dia: 155,
      data: '4 de junho',
      tema: 'Deus: Espírito, Infinito, Eterno — Não Uma Ideia, Mas Uma Pessoa',
      capitulo: 'CMW P.4',
      versiculo: 'João 4.24',
      versiculoTexto: 'Deus é Espírito, e importa que os que o adoram o adorem em espírito e em verdade.',
      confissaoTexto: 'Pergunta 4: O que é Deus? Resposta: Deus é um Espírito, infinito, eterno e imutável em seu ser, sabedoria, poder, santidade, justiça, bondade e verdade.',
      cfwRef: 'CFW 2.1 / CB 1689 2.1',
      cfwComparacao: 'CFW 2.1 e CB 1689 2.1 expandem os atributos de Deus listados no CMW P.4. Os atributos não são partes de Deus — são Deus visto de diferentes ângulos. Deus é simples: cada atributo é idêntico ao seu ser, não acréscimo a ele. A simplicidade divina garante que o Deus de amor é o mesmo Deus de justiça — sem contradição.',
      exposicao: 'O CMW P.4 apresenta Deus em sua essência (Espírito) e seus atributos comunicáveis e incomunicáveis. Infinito significa sem limitação; eterno, sem início ou fim; imutável, sem mudança em qualquer atributo. Esses atributos não são predicados que projetamos sobre Deus — são a realidade que a Escritura revela.',
      reforco: 'Malaquias 3.6',
      aplicacoes: {
        digital: 'Quando o algoritmo apresentar um "Deus" feito à imagem dos nossos desejos, confronte com os atributos do CMW P.4.',
        familia: 'Memorize com a família a resposta do CMW P.4 — é o resumo mais denso do ser de Deus na catequese reformada.',
        filhos: 'Explique: "Deus não muda. O que ele prometeu, ele cumpre. O que ele é hoje, ele será amanhã e sempre."',
        homens: 'O homem que conhece a imutabilidade de Deus não é abalado pelas mudanças da vida — sua âncora não muda.',
        mulheres: 'A mulher que medita na eternidade de Deus encontra estabilidade que nenhuma relação ou conquista humana oferece.',
        igreja: 'A Igreja que prega os atributos de Deus não prega uma divindade genérica — prega o Deus das Escrituras.',
      },
      oracao: 'Senhor, tu és Espírito, infinito, eterno e imutável. Que eu não reduza tua grandeza ao tamanho dos meus conceitos. Que a tua santidade me humilhe, o teu poder me confie, a tua bondade me encoraje, e a tua verdade me governe. Amém.',
      reflexao: 'Deus não é o maior ser que podemos imaginar — ele é maior do que podemos imaginar. Os atributos do CMW P.4 não esgotam Deus; eles apontam para além do que palavras podem conter. A teologia correta produz adoração, não arrogância.',
      aplicacao: 'Escolha um dos atributos do CMW P.4 — sabedoria, poder, santidade, justiça, bondade ou verdade — e medite durante o dia em como esse atributo aparece na sua situação atual. Ore especificamente sobre isso.',
      notas: [
        'BAVINCK, Herman. <em>Reformed Dogmatics</em>. Vol. 2: God and Creation. Grand Rapids: Baker, 2004. Tratamento clássico dos atributos divinos a partir da tradição reformada, com atenção especial à simplicidade e imutabilidade.',
        'DOLEZAL, James E. <em>All That Is in God</em>. Grand Rapids: Reformation Heritage Books, 2017. Defesa rigorosa da impassibilidade e simplicidade divinas contra revisões contemporâneas do teísmo.',
      ],
      notaInicio: 314,
    },
    {
      dia: 156,
      data: '5 de junho',
      tema: 'Um Deus, Três Pessoas — O Mistério da Trindade',
      capitulo: 'CMW P.5/P.6',
      versiculo: 'Mateus 28.19',
      versiculoTexto: 'batizando-os em nome do Pai, e do Filho, e do Espírito Santo',
      confissaoTexto: 'Pergunta 5: Há mais de um Deus? Resposta: Há somente um Deus, vivo e verdadeiro. Pergunta 6: Quantas pessoas há na Divindade? Resposta: Na Divindade há três pessoas: o Pai, o Filho e o Espírito Santo; e estas três são um só Deus, iguais em substância, e iguais em poder e glória.',
      cfwRef: 'CFW 2.3 / CB 1689 2.3',
      cfwComparacao: 'CFW 2.3 e CB 1689 2.3 afirmam a mesma doutrina trinitária: um ser, três pessoas, iguais em essência e glória. O unitarismo nega a Trindade; o triteísmo divide a essência. A ortodoxia confessional preserva ambas as verdades em tensão — monoteísmo e triunidade sem redução.',
      exposicao: 'A Trindade não é contradição matemática — não é 1+1+1=1, mas 1x1x1=1. Um ser em três pessoas distintas, sem confusão de pessoas nem divisão de essência. Esta doutrina não é invenção conciliar — emerge da própria narrativa bíblica: Criação, Encarnação e Pentecostes revelam o Deus trinitário em ação.',
      reforco: '2 Coríntios 13.14',
      aplicacoes: {
        digital: 'Quando encontrar ataques à Trindade nas redes, saiba responder: um ser, três pessoas, iguais em essência — não três deuses.',
        familia: 'Explique ao batizar: o nome (singular) do Pai, do Filho e do Espírito Santo revela a unidade e a triunidade de Deus.',
        filhos: 'Ensine: "Deus é um, mas não está sozinho. Pai, Filho e Espírito são três pessoas que são o mesmo Deus."',
        homens: 'A Trindade é o fundamento da comunidade — o próprio Deus existe em relação. Isso condena o individualismo radical.',
        mulheres: 'A unidade e diversidade na Trindade fundamentam a unidade e diversidade na família e na Igreja.',
        igreja: 'A Igreja que prega a Trindade prega o Deus da Escritura — não uma divindade vaga nem três deuses separados.',
      },
      oracao: 'Pai eterno, Filho redentor, Espírito santificador — um só Deus, glória eterna. Que eu não reduza tua triunidade ao tamanho dos meus conceitos. Que a adoração trinitária governe minha oração, minha teologia e minha vida. Amém.',
      reflexao: 'A doutrina da Trindade não é abstração filosófica — é a identidade do Deus que nos salvou. O Pai planejou, o Filho realizou, o Espírito aplica. Toda a soteriologia é trinitária na sua estrutura.',
      aplicacao: 'Na oração de hoje, dirija-se especificamente a cada pessoa da Trindade pelo que lhe é próprio: ao Pai como Criador e Soberano, ao Filho como Redentor e Mediador, ao Espírito como Santificador e Consolador.',
      notas: [
        'LETHAM, Robert. <em>The Holy Trinity</em>. Phillipsburg: P&R, 2004. Estudo histórico e sistemático da doutrina trinitária desde os Pais da Igreja até as confissões reformadas.',
        'SANDERS, Fred. <em>The Deep Things of God</em>. Wheaton: Crossway, 2010. Demonstra que o Evangelho é intrinsecamente trinitário — não pode ser pregado corretamente sem a estrutura Pai-Filho-Espírito.',
      ],
      notaInicio: 316,
    },
    {
      dia: 157,
      data: '6 de junho',
      tema: 'Os Decretos de Deus: Nada Acontece Fora do Plano Eterno',
      capitulo: 'CMW P.7',
      versiculo: 'Efésios 1.11',
      ...
      confissaoTexto: 'Pergunta 7: Quais são os decretos de Deus? Resposta: Os decretos de Deus são o seu eterno propósito, segundo o conselho da sua vontade, pelo qual, para a sua própria glória, preordenou tudo quanto acontece.',
      cfwRef: 'CFW 3.1 / CB 1689 3.1',
      cfwComparacao: 'CFW 3.1 e CB 1689 3.1 afirmam que Deus ordena tudo sem ser causa do pecado. Os decretos são eternos (antes do tempo), livres (não forçados), eficazes (sempre se cumprem) e abrangentes (tudo — sem exceção). Esta soberania não anula a responsabilidade humana — as confissões afirmam as duas verdades sem harmonização forçada.',
      exposicao: 'O decreto de Deus não é resposta ao que ele previu — é a origem do que acontece. Não há acaso no universo de Deus: cada evento, cada escolha, cada resultado está dentro do eterno conselho divino. Isso não faz de Deus o autor do pecado — os decretos operam através de causas secundárias, preservando a responsabilidade criatural.',
      reforco: 'Provérbios 19.21',
      aplicacoes: {
        digital: 'Quando a ansiedade sobre o futuro atacar, lembre: o Deus que decretou a eternidade também decretou amanhã.',
        familia: 'Ore em família: "Senhor, tudo o que nos acontece está no teu eterno conselho. Confiamos no teu propósito."',
        filhos: 'Ensine: "Nada acontece por acidente. Deus tem um plano e ele sempre se cumpre — para a glória dele e o nosso bem."',
        homens: 'O homem que crê nos decretos de Deus age com responsabilidade e descansa com confiança — sem fatalismo, sem ansiedade.',
        mulheres: 'A mulher que conhece a soberania dos decretos divinos não é dominada pelo medo do inesperado — ela confia no que está escondido.',
        igreja: 'A Igreja que prega os decretos de Deus prega a soberania absoluta — o Evangelho que humilha o orgulho e conforta o aflito.',
      },
      oracao: 'Senhor soberano, teus decretos são eternos e teu conselho não pode ser frustrado. Que eu descanse no teu eterno propósito mesmo quando não o entendo. Que a tua soberania seja minha paz nas circunstâncias que não controlo. Amém.',
      reflexao: 'Os decretos de Deus são a fundação da esperança cristã: se Deus preordenou tudo para sua glória, então nada em minha vida é acidente, desperdício ou fracasso sem redenção. Tudo está dentro do eterno conselho do Pai.',
      aplicacao: 'Identifique uma circunstância em sua vida que parece caótica ou sem sentido. Ore sobre ela reconhecendo que está dentro do eterno decreto de Deus. Escreva uma frase de entrega baseada em Efésios 1.11.',
      notas: [
        'SPROUL, R. C. <em>Chosen by God</em>. Wheaton: Tyndale, 1986. Exposição clara da predestinação e dos decretos divinos dentro da tradição reformada, respondendo às objeções mais comuns.',
        'MULLER, Richard A. <em>Divine Will and Human Choice</em>. Grand Rapids: Baker, 2017. Estudo histórico-teológico sobre a compatibilidade entre soberania divina e responsabilidade humana nas confissões reformadas.',
      ],
      notaInicio: 318,
    },
    {
      dia: 158,
      data: '7 de junho',
      tema: 'Criação: Deus Fez Tudo do Nada — Por Amor, Não Por Necessidade',
      capitulo: 'CMW P.9',
      versiculo: 'Gênesis 1.1',
      versiculoTexto: 'No princípio criou Deus os céus e a terra.',
      confissaoTexto: 'Pergunta 9: Que é a obra da criação? Resposta: A obra da criação é o fato de Deus ter feito, de nada, o mundo e todas as coisas nele contidas, para a sua própria glória, em seis dias, e tudo muito bom.',
      cfwRef: 'CFW 4.1 / CB 1689 4.1',
      cfwComparacao: 'CFW 4.1 e CB 1689 4.1 afirmam a criação ex nihilo (do nada) em seis dias para a glória de Deus. A criação não foi necessidade — Deus é autossuficiente. Foi ato de livre soberania e bondade. O CMW preserva tanto a bondade original da criação quanto seu fim doxológico.',
      exposicao: 'Criação ex nihilo significa que Deus não modelou matéria pré-existente — ele trouxe tudo à existência pela palavra. Isso distingue o Deus bíblico de todos os deuses pagãos que constroem a partir de caos pré-existente. A criação é boa porque o Criador é bom — e sua bondade está impressa em tudo o que ele fez.',
      reforco: 'Salmos 33.6-9',
      aplicacoes: {
        digital: 'Quando consumir conteúdo que trata a criação como acidente evolutivo, lembre: o cosmos é obra de um Criador pessoal e bom.',
        familia: 'Em família, agradeça pela criação: "Senhor, tu fizeste tudo do nada — e tudo o que fizeste é bom. Obrigado."',
        filhos: 'Ensine: "Deus não precisava criar — ele escolheu criar por bondade. Existir é um presente, não um acidente."',
        homens: 'O homem que sabe que é criatura — não criador de si mesmo — tem humildade e responsabilidade diante do Criador.',
        mulheres: 'A mulher que reconhece a bondade original da criação não deprecia o corpo, o mundo ou as tarefas criatuais.',
        igreja: 'A Igreja que prega a criação ex nihilo protege sua congregação do dualismo que despreza o material e do naturalismo que nega o espiritual.',
      },
      oracao: 'Senhor Criador, tu fizeste tudo do nada e tudo que fizeste é bom. Que eu nunca trate a existência como fardo nem a criação como acidente. Que eu administre fielmente o que tu criaste para a tua glória. Amém.',
      reflexao: 'Se Deus criou tudo do nada e declarou tudo muito bom, então o materialismo está errado (a matéria não é má) e o espiritualismo exagerado também (o corpo e o mundo importam). A criação reformada honra tanto o espiritual quanto o material.',
      aplicacao: 'Passe cinco minutos observando algo da criação — planta, céu, animal, criança. Agradeça a Deus especificamente pelo que observou, reconhecendo que foi feito do nada, por amor, para a glória dele.',
      notas: [
        'BAVINCK, Herman. <em>In the Beginning</em>. Grand Rapids: Baker, 1999. Estudo teológico da criação dentro da tradição reformada, incluindo a doutrina da criação ex nihilo e a bondade original do cosmos.',
        'YOUNG, Davis A. <em>The Biblical Flood</em>. Grand Rapids: Eerdmans, 1995. Contexto histórico-teológico para compreender as afirmações confessionais sobre a criação e sua interpretação ao longo da tradição reformada.',
      ],
      notaInicio: 320,
    },
    {
      dia: 159,
      data: '8 de junho',
      tema: 'Providência: Deus Governa Tudo — Nem Acaso, Nem Fado',
      capitulo: 'CMW P.11',
      versiculo: 'Mateus 10.29-30',
      ...
      confissaoTexto: 'Pergunta 11: Quais são as obras de providência de Deus? Resposta: As obras de providência de Deus são o seu sustento e governo, santíssimos, sábios e poderosos de todas as suas criaturas e de todas as suas ações.',
      cfwRef: 'CFW 5.1 / CB 1689 5.1',
      cfwComparacao: 'CFW 5.1 e CB 1689 5.1 expandem a providência em três aspectos: preservação (sustenta o existente), governo (dirige tudo a seus fins), e concurso (age em e através de causas secundárias). Providência não elimina responsabilidade humana — coordena-se com ela. O Deus que sustenta os pardais sustenta seu povo com cuidado infinitamente mais pessoal.',
      exposicao: 'Providência não é deísmo — Deus não criou e abandonou. Nem é panteísmo — Deus não é o universo. Providência é o governo contínuo, pessoal e soberano de Deus sobre cada detalhe da criação. O mesmo Deus que governa galáxias conta os cabelos da cabeça dos seus filhos.',
      reforco: 'Romanos 8.28',
      aplicacoes: {
        digital: 'Quando o noticiário parecer caos puro, lembre: há um Governador por trás da história que dirige tudo a seus fins.',
        familia: 'Ore em família sobre as circunstâncias da semana, reconhecendo a providência de Deus em cada uma delas.',
        filhos: 'Ensine: "Deus cuida até dos pássaros. Ele cuida de você infinitamente mais. Não há detalhe da sua vida fora da atenção dele."',
        homens: 'O homem que crê na providência age com diligência sem ansiedade — trabalha como se dependesse de si, confia como se dependesse de Deus.',
        mulheres: 'A mulher que conhece a providência de Deus não é paralisada pela incerteza — ela age dentro dos meios, confiando no Governador.',
        igreja: 'A Igreja que prega a providência forma membros que não são vítimas das circunstâncias — são instrumentos do governo divino.',
      },
      oracao: 'Senhor providente, nenhum pardal cai sem a tua vontade, e os meus cabelos estão contados. Que eu viva cada dia reconhecendo tua mão em cada detalhe. Que a tua providência seja minha paz nas circunstâncias que não controlo e minha motivação nas que posso influenciar. Amém.',
      reflexao: 'Providência não é fatalismo — não é "o que tem de ser, será". É confiança pessoal em um Governador pessoal que age através de causas reais. O crente age, planeja, trabalha e ora — e tudo isso está dentro da providência de Deus, não fora dela.',
      aplicacao: 'Escreva três circunstâncias da semana passada — uma boa, uma difícil, uma neutra. Para cada uma, escreva como a providência de Deus pode estar operando. Ore reconhecendo o governo de Deus em cada uma.',
      notas: [
        'FLAVEL, John. <em>The Mystery of Providence</em>. Edinburgh: Banner of Truth, 1963 [1678]. O tratado puritano clássico sobre a providência divina, demonstrando como Deus governa cada detalhe da vida do crente.',
        'HELM, Paul. <em>The Providence of God</em>. Downers Grove: IVP, 1994. Tratamento filosófico-teológico da providência dentro do calvinismo, abordando a relação entre soberania divina e liberdade humana.',
      ],
      notaInicio: 322,
    },
  ];
...
// ============================================================================
// Junho B — Dias 160–167 — CMW Perguntas 13–27 — Queda, Pecado, Aliança da Graça, Mediador
// ============================================================================

export function gerarDiasJunho_B(): DevocionalDia[] {
  const dias: DiaCompacto[] = [
    {
      dia: 160,
      data: '9 jun',
      tema: 'Adão Caiu — e Nós Caímos Nele',
      capitulo: 'CMW P.13/P.14',
      versiculo: 'Romanos 5.12',
      ...
      confissaoTexto: 'Pergunta 13: Nossos primeiros pais permaneceram no estado em que foram criados? Resposta: Nossos primeiros pais, sendo deixados à liberdade de sua própria vontade, caíram do estado em que foram criados ao pecarem contra Deus. Pergunta 14: O que é o pecado? Resposta: Pecado é qualquer falta de conformidade com a lei de Deus, ou transgressão da mesma.',
      cfwRef: 'CFW 6.1 / CB 1689 6.1',
      cfwComparacao: 'CFW 6.1 e CB 1689 6.1 afirmam a queda histórica de Adão e Eva e a transmissão da culpa e corrupção a toda a posteridade. O CMW P.14 define pecado com precisão jurídica: falta de conformidade (omissão) ou transgressão (comissão). A distinção entre pecado de omissão e de comissão é fundamental para o exame de consciência cristão.',
      exposicao: 'Adão não caiu por fraqueza estrutural — foi deixado à liberdade de sua própria vontade e escolheu transgredir. O pecado não é apenas um ato isolado, mas uma realidade que entrou na criação e se espalhou a toda a humanidade. A definição do CMW P.14 — falta de conformidade ou transgressão — abrange tanto o que fazemos quanto o que deixamos de fazer.',
      reforco: '1 João 3.4 — "Todo aquele que comete pecado também transgride a lei, porque o pecado é a transgressão da lei."',
      aplicacoes: {
        digital: 'Examine seus conteúdos online: há conformidade com a lei de Deus não apenas no que você posta, mas no que você omite dizer quando deveria falar?',
        familia: 'Leia Romanos 5.12-21 em família e discuta: o que significa sermos solidários com Adão na queda e com Cristo na redenção?',
        filhos: 'Explique: "Todos nós nascemos com um coração que prefere o próprio caminho ao caminho de Deus. É por isso que precisamos de Jesus — não apenas para perdoar o que fazemos, mas para mudar quem somos."',
        homens: 'O homem que compreende a queda não busca culpados externos para seus fracassos — reconhece que a raiz do problema está dentro, e clama por graça transformadora.',
        mulheres: 'A mulher que conhece a doutrina da queda não minimiza o pecado nem desespera diante dele — sabe que há um Salvador maior do que a transgressão.',
        igreja: 'A Igreja que prega a queda histórica de Adão forma membros que entendem por que a graça é necessária — não como complemento, mas como única esperança.',
      },
      oracao: 'Senhor, reconheço que não sou pecador apenas por escolha — nasci assim, herdei esta condição de Adão. Mas tu providenciaste um segundo Adão, Cristo Jesus, em quem todos os que creem são feitos justos. Que eu nunca minimize o pecado nem desespere diante dele — mas que corra sempre ao Redentor. Amém.',
      reflexao: 'A queda não foi acidente — foi escolha. E suas consequências não foram locais — foram universais. Mas onde abundou o pecado, superabundou a graça. O mesmo capítulo que descreve a ruína em Adão proclama a restauração em Cristo.',
      aplicacao: 'Escreva uma definição própria de pecado usando as palavras do CMW P.14. Depois examine seu dia de ontem: houve falta de conformidade (omissão)? Houve transgressão (comissão)? Leve ambas à confissão.',
      notas: [
        'HOEKEMA, Anthony A. <em>Created in God\'s Image</em>. Grand Rapids: Eerdmans, 1986. Análise da imagem de Deus, da queda e de seus efeitos sobre a natureza humana dentro da tradição reformada.',
        'MURRAY, John. <em>The Imputation of Adam\'s Sin</em>. Grand Rapids: Eerdmans, 1959. Estudo exegético detalhado de Romanos 5.12-21, defendendo a imputação direta do pecado de Adão a seus descendentes.',
      ],
      notaInicio: 324,
    },
    {
      dia: 161,
      data: '10 jun',
      tema: 'Pecado Original: Nascemos Réos — Não Apenas Influenciados',
      capitulo: 'CMW P.15/P.16',
      versiculo: 'Salmos 51.5',
      versiculoTexto: 'Eis que em iniquidade fui formado, e em pecado me concebeu minha mãe.',
      confissaoTexto: 'Pergunta 15: Em que estado caiu o homem pela sua queda? Resposta: Pela sua queda, o homem caiu num estado de pecado e miséria. Pergunta 16: Em que consistiu a queda de toda a humanidade em Adão? Resposta: A queda de toda a humanidade em Adão consistiu na imputação de seu primeiro pecado a todos os seus descendentes, na falta de justiça original, e na corrupção de toda a sua natureza, o que é comumente chamado pecado original; juntamente com todas as transgressões atuais que procedem do mesmo.',
      cfwRef: 'CFW 6.2/6.3 / CB 1689 6.2/6.3',
      cfwComparacao: 'CFW 6.2/6.3 e CB 1689 6.2/6.3 afirmam três componentes do pecado original: culpa imputada, privação de justiça original, e corrupção da natureza. Não somos pecadores porque pecamos — pecamos porque somos pecadores. O CMW P.16 preserva essa ordem teológica fundamental contra o semipelagianismo.',
      exposicao: 'Davi não diz que foi ensinado a pecar — diz que foi concebido em iniquidade. O pecado original não é influência cultural nem exemplo negativo: é condição ontológica. Três elementos compõem essa herança: culpa imputada (somos contados como tendo pecado em Adão), privação de justiça (perdemos a retidão original), e corrupção da natureza (toda faculdade está afetada).',
      reforco: 'Efésios 2.3 — "entre os quais também todos nós andamos outrora, segundo os desejos da nossa carne, fazendo a vontade da carne e dos pensamentos, e éramos por natureza filhos da ira, como também os demais."',
      aplicacoes: {
        digital: 'Quando a cultura digital apresentar o ser humano como fundamentalmente bom e apenas mal influenciado, você tem linguagem teológica para responder com verdade e compaixão.',
        familia: 'Converse sobre Salmos 51 em família: por que Davi vai tão fundo na origem do pecado? O que isso revela sobre a necessidade da graça regeneradora?',
        filhos: 'Ensine: "Você não peca porque alguém te ensinou a pecar — você peca porque nasceu com um coração que inclina para o próprio caminho. Por isso Jesus não veio apenas dar um exemplo, mas nos dar um coração novo."',
        homens: 'O homem que conhece o pecado original não busca apenas reformar comportamentos — busca a renovação profunda que só o Espírito produz.',
        mulheres: 'A mulher que entende o pecado original tem compaixão genuína pelas fraquezas dos outros — sabe que todos partem do mesmo ponto de necessidade.',
        igreja: 'A Igreja que prega o pecado original honestamente prepara membros para a evangelização: a profundidade do problema justifica a radicalidade da solução em Cristo.',
      },
      oracao: 'Senhor, não sou pecador apenas por hábito ou ambiente — sou pecador por natureza. Somente tu podes mudar o que está tão fundo. Agradeço que em Cristo recebo não apenas perdão, mas nova natureza. Que o teu Espírito continue a obra de renovação em mim, de dentro para fora. Amém.',
      reflexao: 'A doutrina do pecado original não é pessimismo — é diagnóstico preciso. E diagnóstico preciso possibilita tratamento adequado. Quem subestima o pecado original, subestima a graça. Quem a compreende, valora infinitamente a regeneração.',
      aplicacao: 'Leia Romanos 3.10-18 devagar. Liste os aspectos da natureza humana mencionados. Depois leia Ezequiel 36.26-27 e ore pedindo que Deus continue renovando em você o que só ele pode renovar.',
      notas: [
        'BERKHOF, Louis. <em>Systematic Theology</em>. Grand Rapids: Eerdmans, 1941. O capítulo sobre pecado original apresenta com clareza os três elementos — culpa imputada, privação e corrupção — dentro da tradição reformada clássica.',
        'SPROUL, R.C. <em>Chosen by God</em>. Wheaton: Tyndale House, 1986. Discussão acessível sobre depravação total e sua relação com a eleição soberana de Deus.',
      ],
      notaInicio: 326,
    },
    {
      dia: 162,
      data: '11 jun',
      tema: 'O Pecado Tornou o Homem Miserável — Aqui e Para Sempre',
      capitulo: 'CMW P.17/P.18',
      versiculo: 'Gênesis 3.17-18',
      versiculoTexto: 'E ao homem disse: Porquanto atendeste à voz de tua mulher, e comeste da árvore de que te ordenei que não comesses, maldita é a terra por causa de ti; com trabalho comerás dela todos os dias de tua vida. Espinhos e cardos também te produzirá.',
      confissaoTexto: 'Pergunta 17: Em que consiste a miséria do estado em que caiu o homem? Resposta: Todos os homens, pela sua queda, perderam a comunhão com Deus, estão sob a sua ira e maldição, e assim sujeitos a toda a miséria desta vida, à própria morte, e às penas do inferno para sempre. Pergunta 18: Em que consiste o estado de felicidade que Deus proporciona ao homem caído? Resposta: Deus, movido pela sua mera bondade, escolheu uma multidão de homens para a vida eterna, e estabeleceu com eles um pacto de graça, para os libertar do estado de pecado e miséria, e os colocar num estado de salvação por um Redentor.',
      cfwRef: 'CFW 6.6 / CB 1689 6.6',
      cfwComparacao: 'CFW 6.6 e CB 1689 6.6 afirmam que Deus, mesmo após a queda, não abandonou os eleitos. O CMW P.17-18 contrasta a miséria da queda com a graça da eleição — tragédia e esperança em sequência imediata. A estrutura catequética é pastoral: mostra o problema em toda a sua extensão e imediatamente apresenta a solução divina.',
      exposicao: 'A queda não produziu apenas inconveniências — produziu miséria profunda: perda da comunhão com Deus, sujeição à ira divina, e a perspectiva do inferno eterno. Mas o CMW não deixa o catecúmeno na escuridão — P.18 introduz o pacto de graça como resposta soberana de Deus. A eleição não é doutrina para especulação — é fundamento da esperança do pecador.',
      reforco: 'Efésios 2.4-5 — "Mas Deus, que é rico em misericórdia, pelo seu grande amor com que nos amou, estando nós ainda mortos em nossos delitos, nos deu vida juntamente com Cristo."',
      aplicacoes: {
        digital: 'Quando o conteúdo digital prometer felicidade sem Deus, lembre: a miséria descrita no CMW P.17 é real — e só o Redentor do P.18 pode remediá-la.',
        familia: 'Leia Gênesis 3 em família. Pergunte: quais consequências da queda ainda sentimos hoje? Como o pacto de graça é a resposta de Deus a cada uma delas?',
        filhos: 'Ensine: "A queda trouxe dor, trabalho duro e morte. Mas Deus tinha um plano — um Redentor que viria desfazer o que Adão fez. E esse Redentor é Jesus."',
        homens: 'O homem que conhece a miséria do pecado não busca minimizá-la com sucesso, prazer ou ocupação — reconhece que só a comunhão com Deus restaurada em Cristo resolve o problema mais fundo.',
        mulheres: 'A mulher que entende o pacto de graça sabe que a eleição não é privilégio de arrogância, mas fundamento de humildade e gratidão — foi Deus quem escolheu, não ela.',
        igreja: 'A Igreja que prega tanto a miséria quanto a graça forma membros que levam o evangelho com urgência — o problema é real e a solução é suficiente.',
      },
      oracao: 'Senhor de graça, a queda me mostrou o que sou sem ti — miserável, culpado, mortal. Mas o teu pacto de graça me mostrou quem tu és — rico em misericórdia, movido por bondade que não mereci. Que eu viva entre esses dois polos: consciente do que sou por natureza e grato pelo que sou em Cristo. Amém.',
      reflexao: 'O CMW P.17 e P.18 são inseparáveis: sem o 17, o 18 parece desnecessário. Sem o 18, o 17 é desesperador. A boa pregação do evangelho nunca minimiza o pecado para facilitar a aceitação — aprofunda a tragédia para que a graça seja vista em sua verdadeira grandeza.',
      aplicacao: 'Escreva em duas colunas: na esquerda, as consequências da queda que o CMW P.17 lista; na direita, como o pacto de graça (P.18) responde a cada uma. Termine com oração de gratidão pela eleição soberana.',
      notas: [
        'ROBERTSON, O. Palmer. <em>The Christ of the Covenants</em>. Phillipsburg: P&R, 1980. Estudo abrangente da teologia dos pactos, incluindo o pacto das obras e o pacto de graça como estrutura da história da redenção.',
        'BOSTON, Thomas. <em>Human Nature in Its Fourfold State</em>. Edinburgh: Banner of Truth, 1964 [1720]. Clássico puritano que descreve os quatro estados do homem — inocência, queda, graça e glória — com profundidade pastoral incomparável.',
      ],
      notaInicio: 328,
    },
    {
      dia: 163,
      data: '12 jun',
      tema: 'O Redentor Deve Ser Deus e Homem — Nenhum Outro Poderia Salvar',
      capitulo: 'CMW P.21/P.22',
      versiculo: '1 Timóteo 2.5',
      versiculoTexto: 'Porque há um só Deus e um só Mediador entre Deus e os homens, Jesus Cristo homem.',
      confissaoTexto: 'Pergunta 21: Quem é o Redentor dos eleitos de Deus? Resposta: O único Redentor dos eleitos de Deus é o Senhor Jesus Cristo, que, sendo o eterno Filho de Deus, fez-se homem, e assim foi e continua sendo Deus e homem em duas naturezas distintas e uma só pessoa para sempre. Pergunta 22: Como Cristo, sendo o Filho de Deus, se fez homem? Resposta: Cristo, o Filho de Deus, fez-se homem, tomando para si um verdadeiro corpo e uma alma racional, sendo concebido pelo poder do Espírito Santo no ventre da Virgem Maria, e dela nascido, mas sem pecado.',
      cfwRef: 'CFW 8.2 / CB 1689 8.2',
      cfwComparacao: 'CFW 8.2 e CB 1689 8.2 afirmam a mesma doutrina calcedônica: duas naturezas, uma pessoa, sem confusão, sem separação. O CMW P.21-22 condensa em linguagem catequética o que os Credos Niceno e de Calcedônia elaboraram teologicamente. A formulação "continua sendo" é crucial — a encarnação é permanente, não temporária.',
      exposicao: 'Apenas Deus poderia satisfazer a justiça infinita ofendida; apenas um homem poderia representar a humanidade e morrer em seu lugar. Por isso o Redentor precisava ser as duas coisas — não 50% Deus e 50% homem, mas plenamente Deus e plenamente homem em uma única pessoa. O CMW P.22 precisa: corpo real, alma racional, concepção virginal, sem pecado.',
      reforco: 'João 1.14 — "E o Verbo se fez carne, e habitou entre nós, e vimos a sua glória, como a glória do Unigênito do Pai, cheio de graça e de verdade."',
      aplicacoes: {
        digital: 'Quando encontrar cristologias alternativas online — Jesus apenas humano, apenas divino, ou figura mítica — você tem a formulação precisa do CMW para responder com clareza.',
        familia: 'Leia João 1.1-18 em família. Pergunte: o que significa "o Verbo se fez carne"? Por que era necessário que o Redentor fosse plenamente humano?',
        filhos: 'Ensine: "Jesus é totalmente Deus — criou o mundo. E é totalmente homem — ficou com fome, chorou, dormiu. Ele é o único que pode ser ponte entre Deus e nós."',
        homens: 'O homem que crê na encarnação real entende que seu trabalho, sua dor, sua fadiga foram experimentados pelo Filho de Deus — o que muda sua relação com a cotidianidade.',
        mulheres: 'A mulher que conhece a humanidade real de Jesus sabe que ele compreende as realidades da vida corporificada — não como espectador, mas como participante.',
        igreja: 'A Igreja que defende a cristologia calcedônica preserva o fundamento da soteriologia: só o Deus-homem pode ser o único Mediador.',
      },
      oracao: 'Senhor Jesus, tu és plenamente Deus — e por isso teu sacrifício tem valor infinito. Tu és plenamente homem — e por isso podes ser meu representante. Que eu nunca reduza tua pessoa para torná-la mais compreensível, mas que me curve diante do mistério da encarnação com adoração genuína. Amém.',
      reflexao: 'A encarnação não foi disfarce — foi real. O Filho eterno assumiu humanidade verdadeira, e assim permanece para sempre. Na glória, o Rei dos reis reina como Deus e homem. Isso significa que nossa humanidade redimida tem lugar eterno na glória.',
      aplicacao: 'Leia o Credo Calcedônico (451 d.C.) ou um resumo dele. Compare com o CMW P.21-22. Escreva em suas palavras por que era necessário que o Redentor fosse plenamente Deus E plenamente homem — e por que qualquer diminuição de uma das naturezas arruína a salvação.',
      notas: [
        'MACLEOD, Donald. <em>The Person of Christ</em>. Downers Grove: IVP, 1998. A obra mais completa em inglês sobre a cristologia reformada, tratando da encarnação, das duas naturezas e da unidade da pessoa de Cristo.',
        'WELLUM, Stephen J. <em>God the Son Incarnate</em>. Wheaton: Crossway, 2016. Defesa contemporânea da cristologia calcedônica contra as revisões modernas, com atenção especial à relação entre as duas naturezas.',
      ],
      notaInicio: 330,
    },
    {
      dia: 164,
      data: '13 jun',
      tema: 'Cristo Como Profeta: Ele Revelou o Caminho — Totalmente',
      capitulo: 'CMW P.23/P.24',
      versiculo: 'João 1.18',
      versiculoTexto: 'Ninguém jamais viu a Deus; o Filho unigênito, que está no seio do Pai, esse o deu a conhecer.',
      confissaoTexto: 'Pergunta 23: Que ofícios executa Cristo como nosso Redentor? Resposta: Cristo, como nosso Redentor, executa os ofícios de profeta, de sacerdote e de rei, tanto no seu estado de humilhação como no de exaltação. Pergunta 24: Como Cristo executa o ofício de profeta? Resposta: Cristo executa o ofício de profeta revelando-nos, pela sua Palavra e Espírito, a vontade de Deus para a nossa salvação.',
      cfwRef: 'CFW 8.3 / CB 1689 8.3',
      cfwComparacao: 'CFW 8.3 e CB 1689 8.3 afirmam que Cristo recebeu o Espírito sem medida para exercer o múnus profético. O profeta não apenas prediz — revela. Cristo é a revelação definitiva de Deus: quem viu o Filho viu o Pai. O CMW P.24 destaca que essa revelação continua pela Palavra e pelo Espírito.',
      exposicao: 'Os profetas do AT falavam a Palavra de Deus; Cristo É a Palavra de Deus encarnada. Seu ofício profético não cessou com a ascensão — continua pela Escritura inspirada e pelo Espírito que ilumina. O tríplice ofício (profeta, sacerdote, rei) não é apenas tipologia histórica: Cristo os exerce agora, como Exaltado.',
      reforco: 'Hebreus 1.1-2 — "Havendo Deus antigamente falado muitas vezes e de muitas maneiras aos pais pelos profetas, nestes últimos dias nos falou pelo Filho."',
      aplicacoes: {
        digital: 'Em meio ao ruído informacional da era digital, Cristo profeta fala com autoridade pela sua Palavra. Priorize o que ele revela sobre o que algoritmos sugerem.',
        familia: 'Leia Hebreus 1.1-4 em família. Pergunte: de que formas Deus falou antes? Como ele fala agora? O que significa que Jesus é a revelação definitiva?',
        filhos: 'Ensine: "Jesus não apenas nos contou sobre Deus — ele nos mostrou Deus. Quando você quer saber como Deus é, olha para Jesus nas histórias da Bíblia."',
        homens: 'O homem que reconhece Cristo como profeta não busca revelação adicional além da Escritura — encontra na Palavra escrita tudo o que precisa para a vida e a piedade.',
        mulheres: 'A mulher que conhece o ofício profético de Cristo leva o estudo da Bíblia com seriedade — não como exercício acadêmico, mas como ouvir a voz do seu Senhor.',
        igreja: 'A Igreja que prega Cristo como profeta não relativiza a Escritura — proclama que a Palavra é o meio pelo qual o Profeta ainda fala a seu povo.',
      },
      oracao: 'Senhor Jesus, tu és o Profeta que não apenas anuncia a vontade de Deus — tu a és. Que eu ouça tua voz na Escritura com a reverência de quem está diante da revelação definitiva. Abre meus ouvidos para ouvir e meu coração para obedecer o que revelas. Amém.',
      reflexao: 'A era dos profetas não terminou com Malaquias — terminou com Cristo, a Palavra encarnada. Toda profecia apontava para ele; toda Escritura o revela. Ler a Bíblia é ouvir o Profeta supremo ainda falando.',
      aplicacao: 'Escolha uma passagem dos Evangelhos onde Jesus ensina. Leia-a como se fosse a primeira vez. Depois escreva: o que Cristo como Profeta está revelando aqui sobre Deus? Sobre o homem? Sobre o caminho da salvação?',
      notas: [
        'CALVIN, John. <em>Institutes of the Christian Religion</em>. 2.15.1-2. Westminster John Knox, 1960. A formulação clássica do tríplice ofício de Cristo como profeta, sacerdote e rei, que influenciou toda a teologia reformada subsequente.',
        'VANHOOZER, Kevin J. <em>Is There a Meaning in This Text?</em>. Grand Rapids: Zondervan, 1998. Defende a comunicação divina pela Escritura dentro de um quadro teológico trinitário, relevante para compreender Cristo como Profeta.',
      ],
      notaInicio: 332,
    },
    {
      dia: 165,
      data: '14 jun',
      tema: 'Cristo Como Sacerdote: Ele Se Ofereceu e Ainda Intercede',
      capitulo: 'CMW P.25',
      versiculo: 'Hebreus 7.25',
      versiculoTexto: 'Pelo que também pode salvar perfeitamente os que por ele se aproximam de Deus, vivendo sempre para interceder por eles.',
      confissaoTexto: 'Pergunta 25: Como Cristo executa o ofício de sacerdote? Resposta: Cristo executa o ofício de sacerdote oferecendo-se a si mesmo uma vez em sacrifício para satisfazer a justiça divina e nos reconciliar com Deus, e fazendo intercessão por nós continuamente.',
      cfwRef: 'CFW 8.4/8.8 / CB 1689 8.4/8.8',
      cfwComparacao: 'CFW 8.4 afirma o sacrifício único e suficiente; CFW 8.8 afirma a intercessão contínua. O CMW P.25 une as duas: o sacerdócio de Cristo tem dimensão histórica (sacrifício) e presente (intercessão). A obra da cruz é consumada; a intercessão é contínua. Isso refuta tanto a missa romana (que repete o sacrifício) quanto o deísmo (que ignora a intercessão presente).',
      exposicao: 'O sacerdócio levítico era provisório — sacerdotes que morriam e precisavam ser substituídos, sacrifícios que precisavam ser repetidos. Cristo ofereceu-se uma única vez, com valor eterno, e agora vive para interceder. Não há necessidade de outro sacerdote, outro sacrifício, outra mediação. A intercessão de Cristo não é suplemento à cruz — é fruto e aplicação dela.',
      reforco: 'Romanos 8.34 — "Quem os condenará? Cristo Jesus é o que morreu, ou antes, o que ressuscitou, o qual está à destra de Deus, e também intercede por nós."',
      aplicacoes: {
        digital: 'Quando sentir que suas falhas do dia o separam de Deus, lembre: Cristo intercede agora mesmo por você. A intercessão é contínua — não depende do seu estado emocional.',
        familia: 'Explique em família a diferença entre o sacerdócio levítico (provisório, repetido) e o sacerdócio de Cristo (definitivo, eterno). O que isso significa para a segurança do crente?',
        filhos: 'Ensine: "Jesus não apenas morreu por nós — ele está agora mesmo orando por nós ao Pai. Você tem o Filho de Deus como seu intercessor. Isso é incrível."',
        homens: 'O homem que crê na intercessão de Cristo não carrega sozinho o peso de suas falhas — sabe que há um Advogado junto ao Pai que intercede em seu favor.',
        mulheres: 'A mulher que conhece o sacerdócio de Cristo não busca mérito próprio para se aproximar de Deus — vem com confiança pelo único Mediador.',
        igreja: 'A Igreja que prega o sacerdócio de Cristo forma membros seguros — não porque sejam perfeitos, mas porque têm um Sumo Sacerdote perfeito.',
      },
      oracao: 'Senhor Jesus, tu te ofereceste uma vez para sempre — tua morte é suficiente para todos os meus pecados, passados, presentes e futuros. E agora intercedes por mim diante do Pai. Que eu me aproxime de Deus com confiança — não pela minha dignidade, mas pela tua mediação eterna. Amém.',
      reflexao: 'O crente nunca está sozinho diante de Deus — sempre está representado por Cristo, seu Sumo Sacerdote. A intercessão não é apenas doutrina confortante: é realidade presente que sustenta a vida de oração e a segurança eterna do crente.',
      aplicacao: 'Leia Hebreus 4.14-16 e 7.23-25. Liste o que esses textos ensinam sobre o sacerdócio de Cristo. Depois ore com base neles — venha "com confiança ao trono da graça" sabendo que Cristo intercede por você.',
      notas: [
        'OWEN, John. <em>The Death of Death in the Death of Christ</em>. Edinburgh: Banner of Truth, 1959 [1647]. A defesa clássica puritana da expiação particular e da suficiência do sacrifício único de Cristo.',
        'WELLUM, Stephen J. <em>Christ Alone</em>. Grand Rapids: Zondervan, 2017. Parte da série "Cinco Solos", trata do solus Christus com atenção especial ao sacerdócio único e insuperável de Jesus.',
      ],
      notaInicio: 334,
    },
    {
      dia: 166,
      data: '15 jun',
      tema: 'Cristo Como Rei: Ele Governa a Igreja e Vencerá Todos os Inimigos',
      capitulo: 'CMW P.26',
      versiculo: 'Apocalipse 17.14',
      versiculoTexto: 'Estes pelearão contra o Cordeiro, mas o Cordeiro os vencerá, porque é o Senhor dos senhores e o Rei dos reis.',
      confissaoTexto: 'Pergunta 26: Como Cristo executa o ofício de rei? Resposta: Cristo executa o ofício de rei governando-nos, defendendo-nos, governando e freando os seus e os nossos inimigos.',
      cfwRef: 'CFW 8.1 / CB 1689 8.1',
      cfwComparacao: 'CFW 8.1 e CB 1689 8.1 afirmam que Cristo foi ordenado Cabeça e Salvador da Igreja, Rei e herdeiro de tudo. O reino de Cristo é presente (governa a Igreja pelo Espírito), universal (sobre toda criação) e escatológico (será consumado no retorno). O CMW P.26 destaca três dimensões do reinado: governo, defesa e contenção dos inimigos.',
      exposicao: 'O reino de Cristo não aguarda o futuro — já foi inaugurado na ressurreição e ascensão. Cristo reina agora à direita do Pai. Mas o reinado presente não é ainda a consumação: inimigos ainda resistem, ainda precisam ser freados. O Cordeiro que foi morto é agora o Rei que vence. A história caminha para sua coroação plena.',
      reforco: '1 Coríntios 15.25 — "Porque convém que ele reine até que ponha todos os inimigos debaixo de seus pés."',
      aplicacoes: {
        digital: 'Diante das narrativas de caos e colapso que dominam o ambiente digital, o crente sabe: o Rei reina. A história não está fora de controle — está sob o governo do Cordeiro.',
        familia: 'Ore em família pelo reino de Cristo: por sua Igreja, por suas missões, pela conversão dos perdidos. Reconheçam que orar pelo reino é participar do governo de Cristo.',
        filhos: 'Ensine: "Jesus é Rei — não apenas da nossa família, mas de tudo. Ele governa a história. E um dia todos os joelhos se dobrarão diante dele. Que nossos joelhos já estejam dobrados agora."',
        homens: 'O homem que reconhece Cristo como Rei não age como se fosse ele o dono da história — submete seus planos, ambições e família ao governo do verdadeiro Rei.',
        mulheres: 'A mulher que crê no reinado de Cristo vive com paz em meio à turbulência — sabe que o Governador do universo está ao seu lado e à frente de sua história.',
        igreja: 'A Igreja que prega o reinado de Cristo forma membros missionários — porque o Rei ordenou que o evangelho fosse às nações e prometeu que sua vitória é certa.',
      },
      oracao: 'Rei Jesus, tu reinas — sobre minha vida, minha família, minha história, minha nação e toda a criação. Que eu não viva como se o caos fosse a última palavra. Que minha vida seja ordenada pelo teu governo. E que eu aguarde com esperança o dia em que teu reinado será plenamente manifesto. Amém.',
      reflexao: 'O reino de Cristo não é apenas futuro — é presente. Não é apenas espiritual — é sobre toda a realidade. O Rei que governa a Igreja também governa a história. A esperança cristã não é escapismo — é confiança no Rei que já venceu e ainda vencerá.',
      aplicacao: 'Leia Salmos 2 e Apocalipse 17.14. Escreva o que esses textos ensinam sobre o reinado de Cristo. Depois identifique uma área da sua vida onde você ainda não está vivendo sob o governo do Rei — e ore submetendo essa área a ele.',
      notas: [
        'LADD, George Eldon. <em>The Presence of the Future</em>. Grand Rapids: Eerdmans, 1974. A obra fundamental sobre o reino de Deus como realidade inaugurada no ministério de Cristo e ainda aguardando consumação.',
        'CLOWNEY, Edmund P. <em>The Church</em>. Downers Grove: IVP, 1995. Trata do governo de Cristo sobre sua Igreja como expressão presente de seu reinado universal.',
      ],
      notaInicio: 336,
    },
    {
      dia: 167,
      data: '16 jun',
      tema: 'A Humilhação de Cristo: De Rei a Servo — Para Nos Salvar',
      capitulo: 'CMW P.27',
      versiculo: 'Filipenses 2.7-8',
      versiculoTexto: 'antes, esvaziou-se a si mesmo, tomando a forma de servo, tornando-se em semelhança de homens; e, reconhecido em figura como homem, a si mesmo se humilhou, tornando-se obediente até à morte, e morte de cruz.',
      confissaoTexto: 'Pergunta 27: Em que consistiu a humilhação de Cristo? Resposta: A humilhação de Cristo consistiu no seu nascer, e isso em condição humilde, sujeitando-se à lei, sofrendo as misérias desta vida, a ira de Deus e a morte maldita da cruz, em ser sepultado, e em permanecer debaixo do poder da morte por um tempo.',
      cfwRef: 'CFW 8.4 / CB 1689 8.4',
      cfwComparacao: 'CFW 8.4 e CB 1689 8.4 elaboram os sofrimentos de Cristo — tanto os ativos (guardar a lei) quanto os passivos (suportar o juízo). O CMW P.27 lista a humilhação em estágios: encarnação, vida, paixão, morte, sepultura, permanência sob a morte. Cada estágio corresponde a uma dimensão da salvação que ele conquistou para os seus.',
      exposicao: 'A humilhação de Cristo não começou na cruz — começou no ventre de Maria, em condição humilde. Cada estágio da descida foi parte do plano redentor. Ele se sujeitou à lei para cumpri-la em nosso lugar; sofreu as misérias da vida para santificá-las; experimentou a ira de Deus para nos livrar dela; permaneceu sob a morte por três dias para vencê-la de dentro.',
      reforco: '2 Coríntios 8.9 — "Porque conheceis a graça de nosso Senhor Jesus Cristo, que, sendo rico, se fez pobre por amor de vós, para que pela sua pobreza vos tornásseis ricos."',
      aplicacoes: {
        digital: 'Em uma cultura que glorifica status, poder e visibilidade, a humilhação de Cristo é uma subversão radical. Sua grandeza se manifestou no rebaixamento — o que isso diz sobre os valores do reino?',
        familia: 'Leia Filipenses 2.5-11 em família. Pergunte: por que Paulo usa a humilhação de Cristo como modelo para as relações familiares? O que seria diferente se Cristo fosse nosso padrão de liderança e serviço?',
        filhos: 'Ensine: "Jesus era o Rei do universo, mas nasceu numa manjedoura e morreu numa cruz. Ele não veio ser servido — veio servir. E ele pede que sigamos esse exemplo."',
        homens: 'O homem que medita na humilhação de Cristo tem seu orgulho desestruturado e sua liderança redefinida — liderar é servir, não dominar.',
        mulheres: 'A mulher que conhece a humilhação de Cristo encontra dignidade no serviço — não como resignação, mas como participação no padrão do Rei que se tornou servo.',
        igreja: 'A Igreja que prega a humilhação de Cristo forma líderes servidores e membros que não buscam prestígio — mas que veem no rebaixamento o caminho da exaltação.',
      },
      oracao: 'Senhor Jesus, tu desceste de cada degrau de glória para conquistar minha salvação. Do seio do Pai à manjedoura. Da manjedoura à cruz. Da cruz ao sepulcro. Que a profundidade da tua humilhação me mostre o quanto vales e o quanto eu era amado antes de merecer qualquer amor. Que eu viva em gratidão e em serviço. Amém.',
      reflexao: 'A humilhação de Cristo não foi derrota — foi estratégia redentora. Cada degrau da descida corresponde a uma conquista para os seus. Ele nasceu humildemente para santificar nossa origem. Morreu maldito para nos libertar da maldição. Permaneceu sob a morte para ressurgir como primícias dos que dormem.',
      aplicacao: 'Leia Filipenses 2.5-11 lentamente. Liste cada estágio da humilhação de Cristo mencionado. Para cada um, escreva o que ele conquistou para você naquele estágio. Termine com adoração silenciosa diante do custo da sua salvação.',
      notas: [
        'BERKHOF, Louis. <em>Systematic Theology</em>. Grand Rapids: Eerdmans, 1941. O capítulo sobre os estados de Cristo — humilhação e exaltação — oferece a análise sistemática clássica de cada estágio da descida e ascensão.',
        'STOTT, John R.W. <em>The Cross of Christ</em>. Downers Grove: IVP, 1986. A obra mais influente do século XX sobre a teologia da cruz, tratando da humilhação como coração da redenção e fundamento da ética cristã.',
      ],
      notaInicio: 338,
    },
  ];
...
// ============================================================================
// Junho C — Dias 168–175 — CMW Perguntas 28–38 — Exaltação, Aplicação, Graças
// ============================================================================

function gerarDiasJunho_C(): DiaDevocional[] {
  const dias: DiaCompacto[] = [
    {
      dia: 168,
      data: '17 jun',
      tema: 'A Exaltação de Cristo: Ressuscitou, Ascendeu, Reina e Voltará',
      capitulo: 'CMW P.28',
      versiculo: 'Atos 2.32-33',
      versiculoTexto: 'A este Jesus ressuscitou Deus, do que todos nós somos testemunhas. De sorte que, exaltado pela destra de Deus, e tendo recebido do Pai a promessa do Espírito Santo, derramou isto que vós agora vedes e ouvis.',
      confissaoTexto: 'Pergunta 28: Em que consiste a exaltação de Cristo? Resposta: A exaltação de Cristo consiste na sua ressurreição dentre os mortos ao terceiro dia, na sua ascensão ao céu, em assentar-se à destra de Deus Pai, e em vir a julgar o mundo no último dia.',
      cfwRef: 'CFW 8.4/8.5 / CB 1689 8.4/8.5',
      cfwComparacao: 'CFW 8.4/8.5 e CB 1689 8.4/8.5 elaboram cada estágio da exaltação. O CMW P.28 lista os quatro momentos: ressurreição (vitória sobre a morte), ascensão (regresso ao Pai), sessão (reinado presente), e retorno (juízo final).',
      exposicao: 'A exaltação de Cristo não é separada de sua humilhação — é a sua vindicação. O mesmo Jesus que foi crucificado está agora sentado à destra do Pai. A fé cristã não é apenas teologia da cruz — é teologia do trono.',
      reforco: 'Filipenses 2.9-11: "pelo que também Deus o exaltou soberanamente e lhe deu um nome que é sobre todo o nome."',
      aplicacoes: {
        digital: 'Compartilhe hoje uma frase ou imagem que declare o reinado presente de Cristo — não apenas sua morte, mas sua exaltação. A ressurreição é notícia, não apenas memória.',
        familia: 'Pergunte aos membros da família: você conhece os quatro estágios da exaltação de Cristo? Explique cada um com entusiasmo — ressurreição, ascensão, sessão, retorno.',
        filhos: 'Conte às crianças que Jesus não ficou na cruz nem no túmulo. Ele está vivo, sentado no trono do céu, e um dia voltará. Isso é a maior notícia de todas.',
        homens: 'O homem que sabe que Cristo reina agora não vive ansioso pela história. Ele age com fidelidade no presente porque conhece o fim: o Rei voltará e julgará com justiça.',
        mulheres: 'A mulher que medita na exaltação de Cristo encontra esperança concreta. Ele não é apenas Salvador do passado — ele é Senhor do presente e Juiz do futuro.',
        igreja: 'A Igreja que prega os quatro estágios da exaltação forma uma comunidade escatológica — que vive entre a ascensão e o retorno, com o olhar no trono e os pés no chão.',
      },
      oracao: 'Senhor Jesus exaltado, tu ressuscitaste, ascendeste e reinas agora à destra do Pai. Que a realidade do teu trono governe cada decisão do meu dia. Que eu viva como súdito de um Rei presente, não como órfão de um herói passado. Quando os problemas parecerem maiores que a esperança, lembra-me: tu estás entronizado. E voltarás. Amém.',
      reflexao: 'Os quatro estágios da exaltação de Cristo — ressurreição, ascensão, sessão, retorno — não são doutrina abstrata. São a coluna vertebral da esperança cristã. Cristo ressuscitou: a morte foi vencida. Ascendeu: está com o Pai. Reina: governa a história agora. Voltará: julgará com justiça perfeita. Viver à luz da exaltação é viver com soberania no coração.',
      aplicacao: 'Leia Efésios 1.20-23. Liste o que o texto diz sobre a posição presente de Cristo. Então pergunte: como essa realidade deveria mudar minha ansiedade, meu medo e minha esperança hoje?',
      notas: [
        'BERKHOF, Louis. <em>Systematic Theology</em>. Grand Rapids: Eerdmans, 1941. O capítulo sobre os estados de Cristo analisa cada estágio da exaltação com precisão dogmática reformada.',
        'HOEKEMA, Anthony A. <em>The Bible and the Future</em>. Grand Rapids: Eerdmans, 1979. Trata da sessão e do retorno de Cristo como horizonte escatológico que organiza a ética e a esperança cristã.',
      ],
      notaInicio: 340,
    },
    {
      dia: 169,
      data: '18 jun',
      tema: 'Como os Eleitos São Participantes da Redenção de Cristo?',
      capitulo: 'CMW P.29/P.30',
      versiculo: 'João 1.12',
      versiculoTexto: 'Mas, a todos quantos o receberam, deu-lhes o poder de serem feitos filhos de Deus, a saber, aos que creem no seu nome.',
      confissaoTexto: 'Pergunta 29: Como somos feitos participantes da redenção comprada por Cristo? Resposta: Somos feitos participantes da redenção comprada por Cristo, pela aplicação eficaz da mesma a nós pelo seu Espírito Santo. Pergunta 30: Como o Espírito Santo aplica a nós a redenção comprada por Cristo? Resposta: O Espírito Santo aplica a nós a redenção comprada por Cristo, operando em nós a fé, e desta maneira nos unindo a Cristo em nossa vocação eficaz.',
      cfwRef: 'CFW 10.1 / CB 1689 10.1',
      cfwComparacao: 'CFW 10.1 e CB 1689 10.1 afirmam que o Espírito aplica a redenção pela vocação eficaz. O CMW P.29-30 resume: Cristo comprou; o Espírito aplica; a fé é o instrumento pelo qual nos unimos a Cristo. Sem o Espírito, a cruz não chega ao pecador.',
      exposicao: 'A redenção tem dois momentos: aquisição (Cristo na cruz) e aplicação (Espírito no coração). Objetivamente, Cristo comprou a redenção para todos os eleitos. Subjetivamente, o Espírito a aplica a cada um no tempo designado por Deus.',
      reforco: 'Tito 3.5-6: "nos salvou pela lavagem da regeneração e da renovação do Espírito Santo, que ele derramou sobre nós ricamente por Jesus Cristo."',
      aplicacoes: {
        digital: 'Poste ou compartilhe a distinção: Cristo comprou a redenção; o Espírito a aplica. Essa verdade desfaz tanto o universalismo quanto o moralismo — a salvação é obra completa da Trindade.',
        familia: 'Discutam juntos: como você sabe que o Espírito aplicou a redenção de Cristo a você? Quais sinais você reconhece na sua própria vida — fé, amor, arrependimento?',
        filhos: 'Explique às crianças que Jesus morreu para nos salvar, mas é o Espírito Santo que coloca essa salvação dentro do coração de cada um. Os dois trabalham juntos.',
        homens: 'O homem que entende a distinção entre aquisição e aplicação da redenção não presume da salvação nem desespera. Ele sabe que o Espírito age com soberania e fidelidade.',
        mulheres: 'A mulher que reconhece a obra do Espírito na sua própria fé vive com gratidão genuína — não como alguém que escolheu Deus, mas como alguém que foi escolhida e iluminada.',
        igreja: 'A Igreja que prega o papel do Espírito na aplicação da redenção forma uma comunidade que ora, prega e testemunha dependente — sabendo que a eficácia vem do Espírito, não do método.',
      },
      oracao: 'Espírito Santo, tu aplicaste a redenção de Cristo ao meu coração. Tu operaste a fé. Tu me uniste a Cristo. Que eu nunca trate minha conversão como conquista minha, mas como dom teu. Mantém acesa a chama que tu mesmo acendeste. Aprofunda a união que tu mesmo estabeleceste. Amém.',
      reflexao: 'A pergunta "como a redenção chega ao pecador?" divide teologias. O CMW P.29-30 responde com precisão trinitária: o Pai elege, o Filho compra, o Espírito aplica. Não há lacuna entre a obra de Cristo e o coração do eleito. O Espírito garante que a cruz alcança cada um que o Pai deu ao Filho. A redenção não fica suspensa — ela é aplicada soberana e eficazmente.',
      aplicacao: 'Leia Efésios 2.1-10 devagar. Anote cada ação divina mencionada (ressuscitou, assentou, criou). Depois pergunte: qual foi a minha contribuição para a minha salvação? Use a resposta como ponto de adoração e humildade.',
      notas: [
        'OWEN, John. <em>A Obra do Espírito Santo</em>. São Paulo: Cultura Cristã, 2007. Obra clássica sobre a aplicação da redenção pelo Espírito — vocação, regeneração, fé, arrependimento.',
        'MURRAY, John. <em>Redemption Accomplished and Applied</em>. Grand Rapids: Eerdmans, 1955. O título já resume o CMW P.29-30: Cristo realizou; o Espírito aplica. A obra mais clara sobre o tema em nível popular-acadêmico.',
      ],
      notaInicio: 342,
    },
    {
      dia: 170,
      data: '19 jun',
      tema: 'Vocação Eficaz: Deus Chama — e o Chamado Sempre Responde',
      capitulo: 'CMW P.31',
      versiculo: 'Romanos 8.30',
      versiculoTexto: 'E aos que predestinou, a esses também chamou; e aos que chamou, a esses também justificou; e aos que justificou, a esses também glorificou.',
      confissaoTexto: 'Pergunta 31: O que é vocação eficaz? Resposta: Vocação eficaz é a obra do Espírito de Deus, pela qual, convencendo-nos de nosso pecado e miséria, iluminando nossa mente no conhecimento de Cristo, e renovando nossa vontade, nos persuade e habilita a abraçar Jesus Cristo, livremente oferecido a nós no evangelho.',
      cfwRef: 'CFW 10.1 / CB 1689 10.1',
      cfwComparacao: 'CFW 10.1 e CB 1689 10.1 descrevem a vocação eficaz com os mesmos elementos do CMW P.31: convicção de pecado, iluminação da mente, renovação da vontade. A vocação eficaz distingue-se da vocação externa (pregação geral) por sua eficácia garantida.',
      exposicao: 'A vocação eficaz tem três movimentos: convicção (ver o pecado), iluminação (ver Cristo), renovação (querer Cristo). Deus não apenas oferece — ele cria o querer. Por isso o chamado sempre responde: a disposição de vir é obra do próprio Deus.',
      reforco: 'João 6.37: "Todo o que o Pai me dá virá a mim; e o que vem a mim de maneira nenhuma o lançarei fora."',
      aplicacoes: {
        digital: 'Compartilhe a distinção entre vocação externa (pregação) e vocação eficaz (obra interior do Espírito). Por que muitos ouvem o evangelho e não respondem? Não é falha do evangelho — é a soberania do Espírito que age quando e onde quer.',
        familia: 'Conversem sobre a conversão de cada membro da família. O que Deus usou para convencer, iluminar e renovar cada um? Celebrem juntos a vocação eficaz como obra de Deus.',
        filhos: 'Explique às crianças que quando alguém se converte, não é apenas porque quis — é porque Deus abriu os olhos e o coração daquela pessoa. Isso torna a conversão um presente.',
        homens: 'O homem que entende a vocação eficaz evangeliza com confiança. Ele sabe que sua responsabilidade é pregar fielmente — e que a eficácia depende do Espírito, não de sua eloquência.',
        mulheres: 'A mulher que reconhece a vocação eficaz na sua própria história vive em gratidão profunda. Ela não se converteu porque era melhor ou mais sensível — foi o Espírito que renovou sua vontade.',
        igreja: 'A Igreja que prega a vocação eficaz ora pelo poder do Espírito sobre os corações — e prega o evangelho com urgência, confiando que Deus abrirá os olhos dos seus eleitos.',
      },
      oracao: 'Espírito de Deus, tu me convenceste de pecado quando eu ainda o amava. Tu iluminaste minha mente para ver Cristo quando eu estava cego. Tu renovaste minha vontade para que eu pudesse abraçar o que antes desprezava. Toda a glória é tua. Faz o mesmo por aqueles pelos quais intercedo hoje. Amém.',
      reflexao: 'A vocação eficaz resolve o paradoxo do evangelho: por que alguns respondem e outros não, quando todos ouvem a mesma mensagem? A resposta não está nos ouvintes — está no Espírito. Ele age soberanamente, convencendo, iluminando e renovando. O resultado é certo: o chamado eficazmente sempre vem. Isso é graça que não falha.',
      aplicacao: 'Leia 1 Coríntios 1.26-31. Pergunte: quem Deus chamou? Eram os mais sábios, poderosos ou nobres? O que isso revela sobre a vocação eficaz? Escreva uma oração de gratidão que reconheça que sua resposta ao evangelho foi obra de Deus.',
      notas: [
        'BERKHOF, Louis. <em>Systematic Theology</em>. Grand Rapids: Eerdmans, 1941. O capítulo sobre a vocação eficaz distingue chamado externo e interno, e detalha os três elementos da obra interior do Espírito.',
        'PACKER, J.I. <em>Evangelism and the Sovereignty of God</em>. Downers Grove: IVP, 1961. Clássico que reconcilia soberania divina e responsabilidade humana na evangelização — fundamental para entender a vocação eficaz na prática.',
      ],
      notaInicio: 344,
    },
    {
      dia: 171,
      data: '20 jun',
      tema: 'Justificação: Declarado Justo Gratuitamente — Por Cristo',
      capitulo: 'CMW P.33',
      versiculo: 'Romanos 3.24',
      versiculoTexto: 'sendo justificados gratuitamente pela sua graça, pela redenção que há em Cristo Jesus',
      confissaoTexto: 'Pergunta 33: O que é justificação? Resposta: Justificação é um ato da livre graça de Deus, pelo qual ele perdoa todos os nossos pecados e nos aceita como justos aos seus olhos, somente por causa da justiça de Cristo imputada a nós, e recebida somente pela fé.',
      cfwRef: 'CFW 11.1 / CB 1689 11.1',
      cfwComparacao: 'CFW 11.1 e CB 1689 11.1 elaboram o que o CMW P.33 condensa: justificação é forense (declaração), gratuita (sem mérito), baseada em imputação (justiça de Cristo, não infusão), e recebida pela fé instrumental.',
      exposicao: 'A definição do CMW P.33 contém quatro elementos precisos: ato (não processo), graça (não mérito), imputação (não infusão), fé (não obras). Remova qualquer um e você destrói a justificação reformada. Roma mantém o vocabulário mas altera a substância.',
      reforco: 'Romanos 4.5: "àquele que não pratica, mas crê naquele que justifica o ímpio, a sua fé lhe é atribuída como justiça."',
      aplicacoes: {
        digital: 'Explique em uma publicação a diferença entre imputação e infusão. Imputação: a justiça de Cristo é creditada ao meu favor. Infusão: a justiça seria injetada em mim. A Reforma salvaguardou a imputação.',
        familia: 'Perguntem juntos: na sua vida prática, você age como se a justificação fosse um processo ou um ato completo? Como isso afeta sua paz, seu acesso a Deus, sua autoestima espiritual?',
        filhos: 'Explique às crianças com uma ilustração: imagine que você fez algo errado e seu pai pagou a multa por você. Deus fez isso — e mais: colocou no seu registro a bondade de Jesus.',
        homens: 'O homem que entende a justificação não carrega culpa acumulada. Ele sabe que foi declarado justo — permanentemente — com base no registro perfeito de Cristo, não no seu desempenho diário.',
        mulheres: 'A mulher que descansa na justificação não vive em ansiedade religiosa. Ela não precisa acumular méritos ou cumprir rituais para ser aceita — já é aceita em Cristo, completamente.',
        igreja: 'A Igreja que prega a justificação forense forma crentes com consciência limpa e acesso confiante a Deus — sem a servidão de obras e sem a lassidão do antinomismo.',
      },
      oracao: 'Pai justo, tu me declaraste justo não porque o mereço, mas porque imputaste a mim a justiça perfeita do teu Filho. Que eu nunca adicione nada a essa obra completa. Que eu jamais subtraia dela por descuido doutrinal. Que eu viva em paz, porque o veredito já foi proferido: "Justo." Amém.',
      reflexao: 'A justificação é a artigo pelo qual a Igreja está em pé ou em queda, segundo Lutero. O CMW P.33 preserva essa articulação: é ato (não processo), de graça (não mérito), por imputação (não infusão), recebida pela fé (não pelas obras). Cada palavra é teologicamente carregada. Entender a justificação é entender o evangelho.',
      aplicacao: 'Leia Romanos 5.1-2. Liste os benefícios que derivam da justificação: paz, acesso, esperança. Pergunte: você experimenta esses benefícios? Se não, pode ser que sua compreensão da justificação esteja comprometida. Revise os quatro elementos do CMW P.33.',
      notas: [
        'PACKER, J.I. <em>Justification</em>. In: New Bible Dictionary. Leicester: IVP, 1962. Artigo conciso e preciso sobre a doutrina reformada da justificação, distinguindo-a da perspectiva romana.',
        'SPROUL, R.C. <em>Faith Alone: The Evangelical Doctrine of Justification</em>. Grand Rapids: Baker, 1995. Defesa clara e acessível da justificação forense pela fé, com crítica direta ao documento ECT.',
      ],
      notaInicio: 346,
    },
    {
      dia: 172,
      data: '21 jun',
      tema: 'Adoção: Filho de Deus Por Graça — Não Por Natureza',
      capitulo: 'CMW P.34',
      versiculo: 'Gálatas 4.4-5',
      versiculoTexto: 'mas, quando veio a plenitude do tempo, Deus enviou seu Filho, nascido de mulher, nascido sob a lei, para remir os que estavam sob a lei, a fim de recebermos a adoção de filhos.',
      confissaoTexto: 'Pergunta 34: O que é adoção? Resposta: Adoção é um ato da livre graça de Deus, pelo qual somos recebidos no número e temos direito aos privilégios dos filhos de Deus.',
      cfwRef: 'CFW 12.1 / CB 1689 12.1',
      cfwComparacao: 'CFW 12.1 e CB 1689 12.1 elaboram os privilégios da adoção: acesso ao Pai, o Espírito de adoção, cuidado e disciplina paterna, a herança eterna. O CMW P.34 resume: adoção é ato de graça que concede status de filho e todos os seus direitos.',
      exposicao: 'Cristo é Filho de Deus por natureza — nós somos filhos por adoção. A distinção importa: nossa filiação não é eterna nem essencial, mas é real, legal e permanente. Adotados não podem ser desadotados.',
      reforco: 'Romanos 8.15-16: "Porque não recebestes o espírito de escravidão para estardes outra vez em temor, mas recebestes o Espírito de adoção, pelo qual clamamos: Aba, Pai."',
      aplicacoes: {
        digital: 'Publique a distinção: todos os seres humanos são criaturas de Deus, mas nem todos são filhos de Deus por adoção. A filiação é por graça, mediante a fé — não por nascimento biológico.',
        familia: 'Conversem sobre o que significa ter Deus como Pai — não apenas como Criador. Quais privilégios vêm com essa filiação? Liste-os juntos: acesso, cuidado, herança, disciplina amorosa.',
        filhos: 'Se a família tiver filhos adotados, use a adoção humana como ilustração da divina. Se não, explique: Deus nos escolheu e nos trouxe para sua família — isso é mais do que nascer — é ser escolhido.',
        homens: 'O homem que sabe que foi adotado por Deus não busca aprovação no desempenho. Ele já tem o favor do Pai — permanente, legal, inabalável. Isso liberta para o serviço sem a ansiedade do desempenho.',
        mulheres: 'A mulher adotada por Deus sabe que sua identidade mais profunda não é dada por relacionamentos humanos, conquistas ou aparência — é dada pela filiação divina. Filha do Rei eterno.',
        igreja: 'A Igreja que prega a adoção forma uma comunidade de irmãos reais — não apenas uma associação de crentes. A filiação ao mesmo Pai cria laços mais fortes do que sangue ou cultura.',
      },
      oracao: 'Pai adotante, tu me recebeste não porque eu merecia entrar em tua família, mas porque tua graça me escolheu e teu Filho pagou o preço da adoção. Que eu viva como filho, não como escravo. Que eu clame "Aba, Pai" com confiança filial, não com medo servil. Amém.',
      reflexao: 'A adoção é muitas vezes eclipsada pela justificação nas discussões teológicas — mas é igualmente transformadora. Justificação declara: inocente. Adoção declara: filho. Os dois vereditos juntos definem o status do crente diante de Deus: não apenas livre da culpa, mas introduzido na família. A adoção é o relacionamento mais íntimo que a graça produz.',
      aplicacao: 'Leia 1 João 3.1-3. Maravilhe-se com as palavras "filhos de Deus." Pergunte: essa realidade muda a forma como você se apresenta a Deus na oração? Muda sua identidade? Pratique hoje a oração como filho — com confiança, abertura e afeto.',
      notas: [
        'PACKER, J.I. <em>O Conhecimento de Deus</em>. São Paulo: Cultura Cristã, 2006. O capítulo sobre a adoção é considerado por Packer o mais importante do livro — e um dos textos devocionalmente mais ricos da literatura reformada.',
        'FERGUSON, Sinclair B. <em>Children of the Living God</em>. Edinburgh: Banner of Truth, 1989. Estudo aprofundado da doutrina da adoção e suas implicações para a vida espiritual e a oração.',
      ],
      notaInicio: 348,
    },
    {
      dia: 173,
      data: '22 jun',
      tema: 'Santificação: Deus Nos Faz Santos — Progressivamente',
      capitulo: 'CMW P.35',
      versiculo: '1 Tessalonicenses 4.3',
      versiculoTexto: 'Porque a vontade de Deus é a vossa santificação.',
      confissaoTexto: 'Pergunta 35: O que é santificação? Resposta: Santificação é a obra da livre graça de Deus, pela qual somos renovados em todo o nosso ser à imagem de Deus, e somos cada vez mais habilitados a morrer para o pecado e viver para a justiça.',
      cfwRef: 'CFW 13.1 / CB 1689 13.1',
      cfwComparacao: 'CFW 13.1 e CB 1689 13.1 afirmam que a santificação é real (não apenas declarada), abrangente (todo o ser), e progressiva (crescente). O CMW P.35 captura a dupla direção: mortificação (morrer para o pecado) e vivificação (viver para a justiça).',
      exposicao: 'A santificação não é autoajuda espiritual — é obra de Deus no crente. Mas é obra que envolve o crente: ele coopera, luta, cresce. A graça não elimina o esforço — ela o produz e sustenta.',
      reforco: 'Filipenses 2.12-13: "operai a vossa salvação com temor e tremor; porque Deus é o que opera em vós tanto o querer como o realizar."',
      aplicacoes: {
        digital: 'Publique a distinção: justificação é instantânea e completa; santificação é progressiva e incompleta nesta vida. Confundir as duas gera ou orgulho espiritual ou desespero. A santificação é crescimento real, não perfeição imediata.',
        familia: 'Conversem: em que áreas vocês têm visto crescimento espiritual nos últimos anos? E em que áreas ainda há luta? A santificação abrange "todo o nosso ser" — nenhuma área fica de fora.',
        filhos: 'Explique às crianças que ser cristão não significa ser perfeito agora — significa estar crescendo. Como as plantas crescem devagar mas realmente, assim também os cristãos crescem em santidade.',
        homens: 'O homem que entende a santificação luta contra o pecado com esforço real — sabendo que o esforço é sustentado por Deus. Ele não é passivo ("Deus fará tudo") nem autossuficiente ("é esforço meu").',
        mulheres: 'A mulher que entende a santificação progressiva não se condena quando falha, nem se orgulha quando cresce. Ela reconhece ambos como parte da obra de Deus que ainda está em andamento.',
        igreja: 'A Igreja que prega a santificação progressiva forma uma comunidade de crescimento mútuo — onde membros se encorajam, se responsabilizam e se perdoam, reconhecendo que todos ainda estão em processo.',
      },
      oracao: 'Deus santificador, tu não me deixas como me encontraste. Tu obras em mim — renovando, mortificando, vivificando. Que eu coopere com tua graça com esforço sério e confiante. Que eu nem desespere da minha lentidão nem me orgulhe do meu progresso. A obra é tua — e tu a completarás. Amém.',
      reflexao: 'A santificação ocupa o espaço entre justificação e glorificação — é a vida cristã ordinária. O CMW P.35 a define com dois movimentos: morrer para o pecado (mortificação) e viver para a justiça (vivificação). Nenhum dos dois é automático — exige luta. Mas nenhum dos dois é autogerado — é obra de Deus. A santificação é sinal de vida espiritual: quem não cresce, talvez nunca tenha nascido.',
      aplicacao: 'Leia Romanos 8.13. Pergunte: há um hábito pecaminoso que você tem tolerado em vez de mortificar? Identifique-o, confesse-o e trace um plano concreto de resistência — usando os meios da graça: Palavra, oração, comunidade.',
      notas: [
        'OWEN, John. <em>A Mortificação do Pecado</em>. São Paulo: Cultura Cristã, 2003. O texto mais poderoso já escrito sobre a mortificação como parte central da santificação — com diagnóstico preciso e remédio bíblico.',
        'RYLE, J.C. <em>Santidade</em>. São Paulo: Cultura Cristã, 2009. Clássico do evangelicalismo anglicano que apresenta a santificação prática com vigor pastoral e clareza bíblica.',
      ],
      notaInicio: 350,
    },
    {
      dia: 174,
      data: '23 jun',
      tema: 'Benefícios na Vida: Certeza, Paz, Alegria — Frutos da Graça',
      capitulo: 'CMW P.36',
      versiculo: 'Romanos 5.1',
      versiculoTexto: 'Sendo, pois, justificados pela fé, temos paz com Deus por nosso Senhor Jesus Cristo.',
      confissaoTexto: 'Pergunta 36: Quais são os benefícios que nesta vida acompanham ou derivam da justificação, adoção e santificação? Resposta: Os benefícios que nesta vida acompanham ou derivam da justificação, adoção e santificação são: a certeza do amor de Deus, a paz da consciência, a alegria no Espírito Santo, o crescimento em graça, e a perseverança nela até ao fim.',
      cfwRef: 'CFW 18.1 / CB 1689 18.1',
      cfwComparacao: 'CFW 18.1 e CB 1689 18.1 tratam da certeza da graça — um dos benefícios listados no CMW P.36. Os demais (paz, alegria, crescimento, perseverança) estão distribuídos pelos capítulos XIII, XVII e XVIII das confissões.',
      exposicao: 'Os benefícios da salvação não são apenas futuros — são presentes. Certeza, paz, alegria, crescimento e perseverança são frutos que o Espírito produz agora no crente justificado. A vida cristã não é apenas espera — é posse presente de graças reais.',
      reforco: 'Romanos 15.13: "Ora, o Deus de esperança vos encha de todo o gozo e paz no crer, para que abundeis em esperança pela virtude do Espírito Santo."',
      aplicacoes: {
        digital: 'Publique uma reflexão sobre os cinco benefícios presentes da salvação (CMW P.36): certeza, paz, alegria, crescimento, perseverança. Pergunte: você está desfrutando desses benefícios agora, ou os adiando para o céu?',
        familia: 'Perguntem juntos: de qual desses cinco benefícios você mais precisa hoje? Orem uns pelos outros para que cada um experimente concretamente o benefício que falta.',
        filhos: 'Explique às crianças que ser filho de Deus tem vantagens agora — não apenas no céu. Uma delas é a paz no coração, mesmo quando as coisas estão difíceis. Outra é a alegria que não depende das circunstâncias.',
        homens: 'O homem que conhece os benefícios presentes da salvação não busca satisfação nos substitutos do mundo. Certeza, paz e alegria reais já estão disponíveis em Cristo — e nenhum sucesso ou prazer mundano as imita.',
        mulheres: 'A mulher que descansa na certeza do amor de Deus não vive em ansiedade existencial. Ela sabe que é amada — não por desempenho, mas por graça — e essa certeza produz paz que o mundo não dá.',
        igreja: 'A Igreja que conhece os benefícios presentes da salvação é uma comunidade de alegria genuína — não alegria performática ou circunstancial, mas alegria no Espírito que coexiste com tribulações.',
      },
      oracao: 'Deus de toda graça, tu não prometeste apenas o céu — tu prometeste certeza, paz, alegria, crescimento e perseverança agora. Que eu não desperdice os benefícios presentes por ignorância ou incredulidade. Que hoje eu experimente concretamente o que a salvação produz nesta vida. Amém.',
      reflexao: 'O CMW P.36 lista cinco benefícios presentes: certeza, paz, alegria, crescimento, perseverança. São frutos imediatos — não apenas escatológicos. O crente não precisa esperar a eternidade para desfrutar de graça. Ela já chegou. A pergunta não é se esses benefícios existem, mas: estou desfrutando deles? O Espírito os produce — mas podem ser obscurecidos por descuido doutrinal ou por pecado não mortificado.',
      aplicacao: 'Liste os cinco benefícios do CMW P.36. Ao lado de cada um, escreva sua situação atual: "experimento plenamente", "experimento parcialmente", "raramente experimento". Para os que estão ausentes, pergunte: há pecado não confessado, descuido da Palavra ou afastamento da comunidade que explica a ausência?',
      notas: [
        'BEEKE, Joel R. <em>The Quest for Full Assurance</em>. Edinburgh: Banner of Truth, 1999. Estudo histórico e teológico sobre a certeza da salvação na tradição reformada — tratando de um dos cinco benefícios do CMW P.36.',
        'WATSON, Thomas. <em>A Body of Divinity</em>. London: Banner of Truth, 1958. Exposição clássica do CMW que detalha cada benefício presente da salvação com riqueza devocional e precisão teológica.',
      ],
      notaInicio: 352,
    },
    {
      dia: 175,
      data: '24 jun',
      tema: 'Na Morte e na Ressurreição: Os Benefícios São Eternos',
      capitulo: 'CMW P.37/P.38',
      versiculo: '2 Coríntios 5.1',
      versiculoTexto: 'Porque nós sabemos que, se a nossa casa terrestre deste tabernáculo se desfizer, temos de Deus um edifício, uma casa não feita por mãos, eterna nos céus.',
      confissaoTexto: 'Pergunta 37: Quais são os benefícios que os crentes recebem de Cristo na morte? Resposta: As almas dos crentes são na morte libertadas de todo o pecado e miséria, e passam imediatamente à glória; e seus corpos, ainda unidos a Cristo, descansam em seus sepulcros até a ressurreição. Pergunta 38: Quais são os benefícios que os crentes recebem de Cristo na ressurreição? Resposta: Na ressurreição, os crentes, sendo ressuscitados em glória, serão publicamente reconhecidos e absolvidos no dia do juízo, e receberão plena bem-aventurança no pleno gozo de Deus para sempre.',
      cfwRef: 'CFW 32.1/32.3 / CB 1689 31.1/31.3',
      cfwComparacao: 'CFW 32.1/32.3 e CB 1689 31.1/31.3 afirmam os mesmos benefícios escatológicos: almas imediatamente com Cristo na morte, ressurreição gloriosa, absolvição pública no juízo final, gozo eterno de Deus. O CMW P.37-38 torna isto acessível catequeticamente.',
      exposicao: 'A morte para o crente não é tragédia — é transição. A alma vai imediatamente para a glória; o corpo descansa em Cristo até a ressurreição. Na ressurreição, alma e corpo reunidos entram no pleno gozo de Deus. A esperança cristã é corporalmente concreta.',
      reforco: 'Filipenses 1.21-23: "Para mim o viver é Cristo, e o morrer é lucro... tendo desejo de partir e estar com Cristo, o que é muito melhor."',
      aplicacoes: {
        digital: 'Publique a esperança cristã diante da morte: não aniquilação, não reencarnação, não sono da alma — mas transição imediata para a glória, seguida de ressurreição corporal gloriosa. Esta é a diferença do evangelho.',
        familia: 'Conversem sobre a morte com abertura cristã. O que acontece com o crente quando morre? O que espera na ressurreição? Famílias que entendem o CMW P.37-38 não têm medo da morte — têm esperança concreta.',
        filhos: 'Explique às crianças: quando um cristão morre, sua alma vai imediatamente estar com Jesus. E um dia, Jesus vai ressuscitar o corpo também. Morte não é o fim — é o começo da vida verdadeira.',
        homens: 'O homem que sabe o que o espera na morte e na ressurreição não vive com medo existencial. Ele trabalha, serve e luta — sabendo que até a morte é lucro, e que a ressurreição é certa.',
        mulheres: 'A mulher que medita nos benefícios escatológicos vive com leveza diante da fragilidade da vida. Ela não precisa se agarrar desesperadamente ao presente — o melhor ainda está por vir.',
        igreja: 'A Igreja que prega os benefícios na morte e na ressurreição é uma comunidade que consola os enlutados com esperança real — não platitudes vazias. O CMW P.37-38 é teologia pastoral de alto poder.',
      },
      oracao: 'Senhor da vida e da morte, tu transformaste a morte do crente em porta para a glória. Que eu não tema o que devo antecipar com esperança. Que a certeza da ressurreição me liberte do apego excessivo ao presente. Que eu viva cada dia sabendo que o melhor está à minha frente — não atrás. Amém.',
      reflexao: 'O CMW P.37-38 trata do que vem depois da morte. Para o crente: a alma vai imediatamente à glória (estado intermediário), o corpo descansa em Cristo, e na ressurreição ambos são reunidos para o pleno gozo de Deus para sempre. Isso não é otimismo vago — é escatologia bíblica precisa. A esperança cristã é corporalmente concreta: a salvação redime alma e corpo. A ressurreição é o ápice.',
      aplicacao: 'Leia 1 Coríntios 15.50-58 em voz alta. Deixe as palavras "vitória", "espinho", "morte" e "graças a Deus" moldarem sua meditação. Termine com a pergunta: como a certeza da ressurreição muda a forma como eu vejo minha semana, meu trabalho e meu sofrimento?',
      notas: [
        'HOEKEMA, Anthony A. <em>The Bible and the Future</em>. Grand Rapids: Eerdmans, 1979. O tratamento mais equilibrado e abrangente da escatologia reformada — cobrindo estado intermediário, ressurreição e juízo final.',
        'ALCORN, Randy. <em>Heaven</em>. Wheaton: Tyndale, 2004. Obra popular e biblicamente fundamentada sobre a esperança da ressurreição e da nova criação — acessível para uso em família e no discipulado.',
      ],
      notaInicio: 354,
    },
  ];
...
// ============================================================================
// Junho — Bloco D: Dias 176–181 (CMW P.39–52 — Dever, Lei Moral, Decálogo)
// ============================================================================
  ...
  const dias: DiaCompacto[] = [
    {
      dia: 176,
      data: '25 jun',
      tema: 'O Que Deus Requer Do Homem? Obediência Perfeita',
      capitulo: 'CMW P.39/P.40',
      versiculo: 'Miquéias 6.8',
      versiculoTexto: 'Ele te declarou, ó homem, o que é bom; e que é o que o Senhor pede de ti, senão que pratiques a justiça, e ames a benevolência, e andes humildemente com o teu Deus?',
      confissaoTexto: 'Pergunta 39: Qual é o dever que Deus requer do homem? Resposta: O dever que Deus requer do homem é obediência à sua vontade revelada. Pergunta 40: Que regra deu Deus ao homem a princípio para a sua obediência? Resposta: A regra que Deus a princípio deu ao homem para a sua obediência foi a lei moral.',
      cfwRef: 'CFW 19.1 / CB 1689 19.1',
      cfwComparacao: 'CFW 19.1 e CB 1689 19.1 afirmam que a lei moral foi dada em Adão como pacto de obras e depois reapresentada no Sinai. O CMW P.39-40 conecta dever com lei: o que Deus requer tem forma definida — não é sentimento ou intuição.',
      exposicao: 'O dever humano não é determinado pela cultura, pela maioria ou pela consciência autônoma — é determinado pela vontade revelada de Deus. A lei moral não é opressão: é o caminho do florescimento humano, porque somos feitos à imagem do Deus santo.',
      reforco: 'Deuteronômio 10.12: "E agora, Israel, que é que te pede o Senhor teu Deus, senão que temas o Senhor teu Deus, que andes em todos os seus caminhos, e que o ames?"',
      aplicacoes: {
        digital: 'Na era dos algoritmos e das opiniões virais, o cristão digital recorre à Palavra de Deus — não às tendências — para discernir o que é certo. Compartilhe conteúdo que reflita a vontade revelada de Deus, não apenas o que é popular.',
        familia: 'A família reformada ensina que o dever não é invenção humana — é revelação divina. Pais que ensinam os filhos a perguntar "o que Deus diz sobre isso?" formam consciências ancoradas na Palavra, não na pressão social.',
        filhos: 'Ensine seus filhos: "Deus nos disse o que é bom." Isso significa que não precisamos inventar regras — precisamos aprender e obedecer as regras que Deus já nos deu na Bíblia.',
        homens: 'O homem reformado lidera com base na Palavra revelada de Deus, não em suas opiniões pessoais ou nas expectativas da cultura. Seu padrão de justiça, benevolência e humildade vem de Miquéias 6.8 — não de tendências.',
        mulheres: 'A mulher que fundamenta suas escolhas éticas na vontade revelada de Deus é livre das pressões contraditórias da cultura. Ela sabe o que é bom porque Deus declarou.',
        igreja: 'A Igreja que prega a lei moral como revelação do caráter de Deus — não como lista de proibições — forma discípulos que obedecem por amor, não por medo. CMW P.39-40 é fundamento do discipulado ético.',
      },
      oracao: 'Senhor, tu revelaste à humanidade o que é bom: fazer justiça, amar a benevolência e andar humildemente contigo. Guarda-me de substituir a tua vontade revelada pelas opiniões da cultura ou pelos desejos do meu coração decaído. Que a tua lei seja minha delícia, não meu fardo. Amém.',
      reflexao: 'O CMW P.39-40 ensina que Deus requer obediência à sua vontade revelada e que essa vontade tem forma definida: a lei moral. Isso é pastoralmente libertador — não precisamos adivinhar o que Deus quer. Ele falou. A questão é: ouviremos e obedeceremos?',
      aplicacao: 'Leia Miquéias 6.8 e Deuteronômio 10.12. Escreva três áreas da sua vida onde a vontade revelada de Deus difere dos padrões da cultura ao seu redor. Ore pedindo graça para obedecer a Deus nessas áreas específicas.',
      notas: [
        'FRAME, John M. <em>The Doctrine of the Christian Life</em>. Phillipsburg: P&R, 2008. Tratamento sistemático da lei moral como expressão do caráter de Deus — conectando CMW P.39-40 com toda a ética reformada.',
        'VANHOOZER, Kevin J. <em>The Drama of Doctrine</em>. Louisville: Westminster John Knox, 2005. A obediência à vontade revelada como participação no drama redentor de Deus — perspectiva canônico-dramática.',
      ],
      notaInicio: 356,
    },
    {
      dia: 177,
      data: '26 jun',
      tema: 'Os Dez Mandamentos: A Lei Moral em Dez Palavras',
      capitulo: 'CMW P.41/P.42',
      versiculo: 'Êxodo 20.1-2',
      versiculoTexto: 'E Deus falou todas estas palavras: Eu sou o Senhor teu Deus, que te tirei da terra do Egito, da casa da servidão.',
      confissaoTexto: 'Pergunta 41: Onde se acha sumariamente compreendida a lei moral? Resposta: A lei moral está sumariamente compreendida nos Dez Mandamentos. Pergunta 42: Qual é o sumário dos Dez Mandamentos? Resposta: O sumário dos Dez Mandamentos é que amemos ao Senhor nosso Deus de todo o coração, de toda a alma, de todas as forças e de todo o entendimento; e ao próximo como a nós mesmos.',
      cfwRef: 'CFW 19.2 / CB 1689 19.2',
      cfwComparacao: 'CFW 19.2 e CB 1689 19.2 afirmam que os Dez Mandamentos são a lei moral dada no Sinai — não como novidade, mas como reapresentação da lei inscrita no coração. O duplo amor (a Deus e ao próximo) é o sumário que Jesus mesmo citou (Mt 22.37-40).',
      exposicao: 'Os Dez Mandamentos não são dez regras arbitrárias — são a expressão do caráter de Deus aplicado às relações humanas. As quatro primeiras tábuas ordenam o amor a Deus; as seis últimas, o amor ao próximo. O duplo amor é indivisível: quem odeia o irmão não ama a Deus.',
      reforco: 'Mateus 22.37-40: "Amarás o Senhor teu Deus de todo o teu coração... Este é o primeiro e grande mandamento. E o segundo, semelhante a este, é: Amarás o teu próximo como a ti mesmo."',
      aplicacoes: {
        digital: 'O cristão digital que memoriza e medita no Decálogo tem uma bússola ética clara num mundo de dilemas morais complexos. Compartilhar os Dez Mandamentos com explicação pastoral é um ato de misericórdia cultural.',
        familia: 'A família que estuda o Decálogo junto tem linguagem moral comum. Pais e filhos que conhecem os Dez Mandamentos sabem a diferença entre "eu não gosto" e "Deus proibiu" — distinção fundamental para a formação ética.',
        filhos: 'Memorize os Dez Mandamentos com seus filhos. Não apenas as palavras — explique o que cada um requer e o que proíbe. O duplo amor (Deus e próximo) é o resumo que Jesus mesmo usou.',
        homens: 'O homem que conhece o Decálogo tem padrão moral objetivo para liderar a família. Não inventa regras — aplica as dez palavras de Deus com sabedoria pastoral ao cotidiano doméstico.',
        mulheres: 'A mulher que medita nos Dez Mandamentos como expressão do amor duplo — a Deus e ao próximo — tem motivação e direção para todas as suas relações: conjugal, materna, comunitária.',
        igreja: 'A Igreja que ensina sistematicamente o Decálogo — com seus requisitos e proibições — forma membros com consciência moral bíblica robusta, capazes de discernir em situações que a cultura torna ambíguas.',
      },
      oracao: 'Senhor que falaste as dez palavras no Sinai, que teu Decálogo seja minha delícia e não meu fardo. Que eu ame o que tu amas e odeie o que tu odeias. Que o duplo amor — a ti e ao próximo — governe meus pensamentos, palavras e ações. Amém.',
      reflexao: 'O CMW P.41-42 resume os Dez Mandamentos no duplo amor de Mateus 22. Isso revela que a lei não é uma lista de proibições, mas a expressão de duas relações fundamentais: com Deus (as quatro primeiras) e com o próximo (as seis últimas). Quem ama corretamente cumpre a lei.',
      aplicacao: 'Liste os Dez Mandamentos de memória. Agrupe os quatro primeiros (relação com Deus) e os seis últimos (relação com o próximo). Pergunte: qual deles você mais frequentemente viola por omissão — não fazendo o que é requerido?',
      notas: [
        'WATSON, Thomas. <em>The Ten Commandments</em>. Edinburgh: Banner of Truth, 1692/1965. Clássico puritano que expõe cada mandamento com seus requisitos e proibições — padrão para o estudo do Decálogo.',
        'EDWARDS, Jonathan. <em>Charity and Its Fruits</em>. Edinburgh: Banner of Truth, 1852/1969. O amor ao próximo como fruto da lei moral interiorizada pelo Espírito — conexão direta com CMW P.42.',
      ],
      notaInicio: 358,
    },
    {
      dia: 178,
      data: '27 jun',
      tema: 'O Prólogo dos Mandamentos: Deus Resgata Antes de Exigir',
      capitulo: 'CMW P.43',
      versiculo: 'Deuteronômio 5.6',
      versiculoTexto: 'Eu sou o Senhor teu Deus, que te tirei da terra do Egito, da casa da servidão.',
      confissaoTexto: 'Pergunta 43: Qual é o prólogo dos Dez Mandamentos? Resposta: O prólogo dos Dez Mandamentos é este: "Eu sou o Senhor teu Deus, que te tirei da terra do Egito, da casa da servidão." Com o qual Deus nos ensina que, por ser ele o Senhor e nosso Deus e Redentor, nós somos obrigados a guardar todos os seus mandamentos.',
      cfwRef: 'CFW 19.5 / CB 1689 19.5',
      cfwComparacao: 'CFW 19.5 e CB 1689 19.5 afirmam que a lei moral obriga todos. Mas o prólogo do CMW P.43 revela a lógica da obediência reformada: primeiro o resgate (Êxodo), depois a lei (Sinai). A obediência nasce da gratidão, não do medo. Lei após graça — nunca ao contrário.',
      exposicao: 'O Êxodo precede o Sinai: Deus primeiro liberta, depois legisla. Isso determina a motivação correta da obediência: não obedecemos para ser salvos, mas porque fomos salvos. A lei reformada é lei de filhos libertos, não de escravos temerosos.',
      reforco: 'Romanos 12.1: "Rogo-vos, pois, irmãos, pela compaixão de Deus, que apresenteis os vossos corpos em sacrifício vivo... o que é o vosso culto racional."',
      aplicacoes: {
        digital: 'O cristão digital que entende o prólogo dos mandamentos não usa a lei como vara para bater nos outros nas redes sociais — usa a graça como motivação para a própria obediência. Primeiro resgate, depois exigência.',
        familia: 'A família que recorda constantemente o "Êxodo" — a salvação de Deus em Cristo — obedece como filhos libertos, não como escravos temerosos. O prólogo dos mandamentos é o fundamento da disciplina doméstica baseada em graça.',
        filhos: 'Ensine seus filhos: "Obedecemos porque Deus nos amou primeiro — não para ganhar seu amor." Isso é a lógica do prólogo dos mandamentos. A obediência nasce da gratidão pelo resgate, não do medo do castigo.',
        homens: 'O homem que lidera com o prólogo dos mandamentos em mente lidera com graça como fundamento: lembra à família o amor redentor de Deus antes de exigir obediência. A autoridade pastoral nasce do evangelho.',
        mulheres: 'A mulher que obedece a Deus motivada pela gratidão pelo resgate — não pelo medo da punição — vive numa liberdade que a santidade legalista nunca pode dar. O prólogo é antídoto ao perfeccionismo ansioso.',
        igreja: 'A Igreja que prega lei após graça — nunca ao contrário — forma obedientes por amor, não por medo. O prólogo dos mandamentos é o padrão para toda pregação da lei: primeiro o evangelho, depois a exigência.',
      },
      oracao: 'Senhor Redentor, tu agiste antes de exigir: primeiro o Êxodo, depois o Sinai. Que minha obediência nasça da gratidão pelo teu resgate em Cristo, não do temor do castigo. Que eu me lembre todo dia: tu me tiraste da casa da servidão — e isso muda tudo. Amém.',
      reflexao: 'O CMW P.43 ensina que o prólogo dos mandamentos é a declaração de identidade e ação redentora de Deus: "Eu sou o Senhor... que te tirei." A lei que se segue não é lei de conquistar a salvação — é lei de quem já foi salvo. A sequência teológica importa: evangelho primeiro, lei depois.',
      aplicacao: 'Leia Êxodo 19-20. Observe a sequência: primeiro Deus resgata (capítulos 1-18), depois legisla (capítulo 20). Reflita: em que áreas da sua vida você ainda obedece por medo em vez de por gratidão? Peça ao Espírito que transforme sua motivação.',
      notas: [
        'KLINE, Meredith G. <em>The Structure of Biblical Authority</em>. Grand Rapids: Eerdmans, 1972. O prólogo dos mandamentos como suzerain treaty — o Rei que resgata antes de impor obrigações ao vassalo liberto.',
        'HORTON, Michael. <em>The Law of Perfect Freedom</em>. Chicago: Moody, 1993. A lógica evangélica do prólogo: graça precede lei — implicações para a motivação da obediência cristã contemporânea.',
      ],
      notaInicio: 360,
    },
    {
      dia: 179,
      data: '28 jun',
      tema: 'Primeiro Mandamento: Somente Deus — Nenhum Substituto',
      capitulo: 'CMW P.44/P.45/P.46',
      versiculo: 'Êxodo 20.3',
      versiculoTexto: 'Não terás outros deuses diante de mim.',
      confissaoTexto: 'Pergunta 44: Qual é o primeiro mandamento? Resposta: O primeiro mandamento é este: Não terás outros deuses diante de mim. Pergunta 45: Que é o que o primeiro mandamento requer? Resposta: O primeiro mandamento requer que conheçamos e reconheçamos a Deus como o único verdadeiro Deus e nosso Deus, e que o adoremos e glorifiquemos como ele merece. Pergunta 46: Que é o que o primeiro mandamento proíbe? Resposta: O primeiro mandamento proíbe negar a Deus, ou não o adorar e glorificar como Deus e nosso Deus; e proíbe dar a outros o culto e glória que somente são devidos a Deus.',
      cfwRef: 'CFW 21.1 / CB 1689 22.1',
      cfwComparacao: 'CFW 21.1 e CB 1689 22.1 afirmam o Princípio Regulador: Deus determina como deve ser adorado. O CMW P.44-46 estabelece que o primeiro mandamento governa o objeto da adoração: somente Deus. Idolatria é dar a qualquer coisa o lugar que pertence somente a Deus.',
      exposicao: 'O primeiro mandamento não apenas proíbe ídolos de pedra — proíbe qualquer substituto de Deus no coração: dinheiro, reputação, família, segurança, prazer. Idolatria é funcional: o ídolo é aquilo que você serve, teme e busca quando Deus parece ausente.',
      reforco: '1 João 5.21: "Filhinhos, guardai-vos dos ídolos."',
      aplicacoes: {
        digital: 'No mundo digital, os ídolos são invisíveis mas poderosos: seguidores, likes, influência, reputação online. O primeiro mandamento pergunta: a quem você serve quando ninguém está olhando? O que você busca quando se sente inseguro?',
        familia: 'A família pode tornar-se ídolo quando é amada mais do que Deus — quando preservar a paz familiar se torna mais importante do que a obediência a Deus. O primeiro mandamento guarda a família de si mesma.',
        filhos: 'Ensine seus filhos a identificar ídolos modernos: o que eles mais temem perder? O que buscam para se sentir seguros e felizes quando Deus parece distante? Isso revela o que ocupa o lugar de Deus no coração.',
        homens: 'O ídolo masculino mais comum é a competência e o sucesso: a necessidade de ser admirado, respeitado e bem-sucedido. O primeiro mandamento exige que o homem busque a glória de Deus — não a sua própria.',
        mulheres: 'O ídolo feminino mais comum é o relacionamento e a aprovação: a necessidade de ser amada e aceita. O primeiro mandamento liberta a mulher da escravidão à aprovação humana — Deus já a aprovou em Cristo.',
        igreja: 'A Igreja pode idolatrar tradição, crescimento numérico ou relevância cultural. O primeiro mandamento exige que a Igreja busque a glória de Deus como fim supremo de todas as suas atividades.',
      },
      oracao: 'Deus único e verdadeiro, eu confesso que meu coração é uma fábrica de ídolos. Que o teu Espírito revele os substitutos que coloquei no teu lugar: segurança, aprovação, sucesso, conforto. Sê tu meu único Deus — em quem confio, a quem sirvo e em quem descanso. Amém.',
      reflexao: 'O CMW P.44-46 expõe o primeiro mandamento em três camadas: o mandamento em si, o que requer (conhecer e adorar a Deus) e o que proíbe (qualquer substituto). A idolatria moderna é principalmente funcional — não precisamos de templos pagãos para ter ídolos. O coração humano cria substitutos invisíveis mas igualmente tirânicos.',
      aplicacao: 'Pergunte-se: quando estou ansioso ou inseguro, para onde meu coração corre primeiro — Deus ou algum substituto? Esse substituto é seu ídolo funcional. Confesse-o a Deus e peça graça para correr a Cristo em vez dele.',
      notas: [
        'KELLER, Timothy. <em>Counterfeit Gods</em>. New York: Dutton, 2009. A idolatria funcional como diagnóstico do coração moderno — leitura indispensável para aplicar o primeiro mandamento à vida contemporânea.',
        'CALVIN, John. <em>Institutes of the Christian Religion</em>. I.11. Westminster: John Knox, 1559/1960. O coração humano como "fábrica perpétua de ídolos" — formulação clássica que o CMW P.44-46 pressupõe.',
      ],
      notaInicio: 362,
    },
    {
      dia: 180,
      data: '29 jun',
      tema: 'Segundo Mandamento: Adorar Corretamente — Nenhuma Imagem',
      capitulo: 'CMW P.47/P.48/P.49',
      versiculo: 'João 4.23-24',
      versiculoTexto: 'Mas a hora vem, e agora é, em que os verdadeiros adoradores adorarão o Pai em espírito e em verdade; porque o Pai procura a tais que assim o adorem. Deus é Espírito, e importa que os que o adoram o adorem em espírito e em verdade.',
      confissaoTexto: 'Pergunta 47: Qual é o segundo mandamento? Resposta: O segundo mandamento é este: Não farás para ti imagem de escultura, nem semelhança alguma das coisas que estão em cima nos céus, nem embaixo na terra, nem nas águas debaixo da terra. Não te encurvarás a elas nem as servirás; porque eu, o Senhor teu Deus, sou Deus zeloso, que visito a iniquidade dos pais nos filhos até a terceira e quarta geração daqueles que me odeiam; e faço misericórdia a milhares dos que me amam e guardam os meus mandamentos. Pergunta 48: Que é o que o segundo mandamento requer? Resposta: O segundo mandamento requer o recebimento, a observância e a manutenção pura e completa de toda a adoração e ordenanças religiosas que Deus nos ordenou na sua Palavra. Pergunta 49: Que é o que o segundo mandamento proíbe? Resposta: O segundo mandamento proíbe adorar a Deus por imagens ou por qualquer outra forma não ordenada em sua Palavra.',
      cfwRef: 'CFW 21.1 / CB 1689 22.1',
      cfwComparacao: 'CFW 21.1 e CB 1689 22.1 enunciam o Princípio Regulador da Adoração — que o CMW P.47-49 aplica ao segundo mandamento. O primeiro mandamento governa o objeto (quem adorar); o segundo governa o modo (como adorar). Ambos são necessários.',
      exposicao: 'O segundo mandamento não proíbe apenas estatuetas — proíbe toda representação visual de Deus como meio de adoração. Deus é Espírito: representá-lo em imagem inevitavelmente distorce quem ele é. A proibição protege a transcendência e a glória de Deus.',
      reforco: 'Deuteronômio 4.15-16: "Guardai, pois, muito as vossas almas; porque nenhuma forma vistes no dia em que o Senhor falou convosco em Horebe... para que não vos corrompais."',
      aplicacoes: {
        digital: 'O cristão digital avalia os elementos da adoração pública pelo critério da Palavra — não pela eficácia do marketing ou pelo apelo emocional. O segundo mandamento é o filtro reformado para escolher uma igreja.',
        familia: 'A família reformada adora sem imagens visuais de Deus — nas orações, hinos e leituras. Isso protege a concepção que os filhos formam de Deus: ele é maior do que qualquer imagem humana pode capturar.',
        filhos: 'Explique aos filhos: "Não fazemos imagens de Deus porque Deus é Espírito — ele é maior do que qualquer desenho. Quando imaginamos Deus como um velhinho de barbas brancas, estamos fazendo uma imagem falsa dele."',
        homens: 'O homem que lidera o culto familiar segundo o Princípio Regulador garante que a adoração doméstica seja formada pela Palavra — não por experiências emocionais ou inovações culturais. O segundo mandamento governa o como da adoração.',
        mulheres: 'A mulher que adora em espírito e em verdade (Jo 4.23-24) não depende de imagens visuais para se sentir perto de Deus. Ela aprende a adorar mediante a Palavra — meditação, salmos, oração verbal.',
        igreja: 'A Igreja reformada aplica o Princípio Regulador: inclui na adoração pública apenas o que a Palavra ordena e exclui o que a Palavra não autoriza. O segundo mandamento é o fundamento desta prática histórica.',
      },
      oracao: 'Deus que és Espírito, guarda-me de criar imagens — mentais ou físicas — que distorçam quem tu és. Que eu te adore como tu determinaste: em espírito e em verdade, segundo a tua Palavra revelada. Que o zelo que tens pela tua glória me ensine a adorar corretamente. Amém.',
      reflexao: 'O CMW P.47-49 aplica o segundo mandamento ao modo da adoração. A diferença entre o primeiro e o segundo mandamento é crucial: o primeiro pergunta "a quem adorar?" e o segundo pergunta "como adorar?". O Princípio Regulador da Adoração responde ao segundo: somente como Deus ordenou em sua Palavra.',
      aplicacao: 'Avalie os elementos do culto que você frequenta: pregação da Palavra, leitura da Escritura, oração, cânticos de louvor, batismo, ceia. Pesquise em que versículos cada elemento está fundamentado. O segundo mandamento requer que a adoração seja bíblica — não apenas bonita ou emocionante.',
      notas: [
        'FESKO, J.V. <em>Word, Water, and Spirit</em>. Grand Rapids: Reformation Heritage, 2010. O Princípio Regulador da Adoração aplicado aos sacramentos — fundamento bíblico-confessional do segundo mandamento.',
        'FRAME, John M. <em>Worship in Spirit and Truth</em>. Phillipsburg: P&R, 1996. Defesa do Princípio Regulador com abertura para a distinção entre elementos e circunstâncias da adoração.',
      ],
      notaInicio: 364,
    },
    {
      dia: 181,
      data: '30 jun',
      tema: 'Terceiro Mandamento: O Nome de Deus É Santo — Não Palavrão',
      capitulo: 'CMW P.50/P.51/P.52',
      versiculo: 'Levítico 22.32',
      versiculoTexto: 'E não profanareis o meu santo nome, para que eu seja santificado no meio dos filhos de Israel; eu sou o Senhor que vos santifico.',
      confissaoTexto: 'Pergunta 50: Qual é o terceiro mandamento? Resposta: O terceiro mandamento é este: Não tomarás o nome do Senhor teu Deus em vão; porque o Senhor não terá por inocente aquele que tomar o seu nome em vão. Pergunta 51: Que é o que o terceiro mandamento requer? Resposta: O terceiro mandamento requer o uso santo e reverente dos nomes, títulos, atributos, ordenanças, Palavra e obras de Deus. Pergunta 52: Que é o que o terceiro mandamento proíbe? Resposta: O terceiro mandamento proíbe toda profanação ou abuso de qualquer coisa pela qual Deus se dá a conhecer.',
      cfwRef: 'CFW 22.2 / CB 1689 23.2',
      cfwComparacao: 'CFW 22.2 e CB 1689 23.2 tratam dos juramentos — aplicação do terceiro mandamento. O CMW P.50-52 amplia o escopo: não apenas blasfêmia verbal, mas todo abuso do nome de Deus — incluindo usar linguagem religiosa de modo vazio, hipócrita ou manipulador.',
      exposicao: 'Tomar o nome de Deus em vão não é apenas xingamento — é usar o nome de Deus para fins não dignos de Deus: jurar falsamente, invocar Deus para justificar pecados, usar linguagem religiosa como marketing. O nome de Deus é sua revelação pessoal — profaná-lo é profanar a Deus mesmo.',
      reforco: 'Mateus 6.9: "Santificado seja o teu nome" — a primeira petição do Pai-Nosso é pela honra do nome de Deus. A oração corrige o pecado que o terceiro mandamento proíbe.',
      aplicacoes: {
        digital: 'Nas redes sociais, o nome de Deus é frequentemente invocado para legitimar opiniões políticas, produtos comerciais e causas ideológicas. O terceiro mandamento proíbe usar o nome de Deus como endosso para agenda humana.',
        familia: 'A família que usa o nome de Deus com reverência — no culto, na oração, na instrução — forma filhos que entendem que falar de Deus é falar de alguém real e santo, não usar uma palavra mágica ou um palavrão suavizado.',
        filhos: 'Explique aos filhos que "não tomarás o nome de Deus em vão" não é apenas sobre palavrões — é sobre respeito. Quando falamos de Deus, estamos falando de quem Ele é. Isso requer cuidado, reverência e verdade.',
        homens: 'O homem que lidera com integridade verbal — nunca usando o nome de Deus para manipular, impressionar ou justificar pecados — honra o terceiro mandamento. Sua palavra deve ser sim ou não — com reverência pelo Deus que tudo vê.',
        mulheres: 'A mulher que usa o nome de Deus em oração sincera, não em exclamações vazias, e que fala de Deus com precisão teológica e amor real, santifica o nome de Deus nas suas relações cotidianas.',
        igreja: 'A Igreja que invoca o nome de Deus em toda pregação, oração e louvor tem responsabilidade de fazê-lo com reverência e verdade. Linguagem religiosa usada como marketing eclesial viola o terceiro mandamento.',
      },
      oracao: 'Santo Senhor cujo nome é acima de todo nome, que eu nunca tome o teu nome em vão — nem em xingamentos, nem em orações vazias, nem em linguagem religiosa sem reverência. Santificado seja o teu nome: primeiro no meu coração, depois nos meus lábios. Amém.',
      reflexao: 'O CMW P.50-52 revela que o terceiro mandamento tem escopo muito maior do que palavrões. Qualquer uso do nome, títulos, atributos, ordenanças ou obras de Deus de modo não santo é violação. Isso inclui: orar sem atenção, pregar sem convicção, invocar Deus para legitimar agendas humanas, usar linguagem religiosa como estratégia de marketing.',
      aplicacao: 'Avalie sua fala sobre Deus nesta semana: nas conversas, nas redes sociais, nas orações. Você usou o nome de Deus com reverência e precisão? Ou usou-o de modo vazio, habitual ou manipulador? Peça ao Espírito que santifique sua língua para honrar o nome santo de Deus.',
      notas: [
        'CALVIN, John. <em>Institutes of the Christian Religion</em>. II.8.22. Westminster: John Knox, 1559/1960. O terceiro mandamento como proteção da santidade do nome divino em toda comunicação humana sobre Deus.',
        'CHAPELL, Bryan. <em>Christ-Centered Preaching</em>. Grand Rapids: Baker, 2005. O dever homilético de pregar com reverência ao nome de Deus — aplicação pastoral do terceiro mandamento ao ministério da Palavra.',
      ],
      notaInicio: 366,
    },
  ];
